...
class ApiBase(ServiceBase):
    ...
    async def post_drift_settle_pnl(self) -> "PostDriftSettlePnlResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def post_drift_settle_pn_ls(self) -> "PostDriftSettlePnLsResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def post_cancel_by_client_order_id(self) -> "PostCancelOrderResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def get_order_by_id(self) -> "GetOrderByIdResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def post_settle_pnl(self) -> "PostSettlePnlResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)

    async def post_settle_pn_ls(self) -> "PostSettlePnLsResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
