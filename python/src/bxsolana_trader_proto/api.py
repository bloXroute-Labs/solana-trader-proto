...
class GetTickersResponseV2(betterproto.Message):
    market_tickers: Dict[str, "Candle"] = betterproto.map_field(
        1, betterproto.TYPE_STRING, betterproto.TYPE_MESSAGE
    )


@dataclass
class GetKlineRequestV2(betterproto.Message):
    market: str = betterproto.string_field(1)
...
@dataclass
class GetKlineResponseV2(betterproto.Message):
...
class Candle(betterproto.Message):
    ...
    open: float = betterproto.double_field(4)
    ...
    volume: float = betterproto.double_field(9)
    count: float = betterproto.double_field(10)
