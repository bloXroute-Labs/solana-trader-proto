...
// 	protoc        v3.19.3
// source: harmonic_proto/auth.proto
...
func (Role) Descriptor() protoreflect.EnumDescriptor {
	return file_harmonic_proto_auth_proto_enumTypes[0].Descriptor()
}

func (Role) Type() protoreflect.EnumType {
	return &file_harmonic_proto_auth_proto_enumTypes[0]
}
...
func (Role) EnumDescriptor() ([]byte, []int) {
	return file_harmonic_proto_auth_proto_rawDescGZIP(), []int{0}
}
...
func (x *GenerateAuthChallengeRequest) Reset() {
	*x = GenerateAuthChallengeRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_harmonic_proto_auth_proto_msgTypes[0]
...
func (x *GenerateAuthChallengeResponse) Reset() {
	*x = GenerateAuthChallengeResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_harmonic_proto_auth_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GenerateAuthChallengeResponse) Descriptor() ([]byte, []int) {
	return file_harmonic_proto_auth_proto_rawDescGZIP(), []int{1}
}
...
func (x *GenerateAuthTokensRequest) Reset() {
	*x = GenerateAuthTokensRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_harmonic_proto_auth_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GenerateAuthTokensRequest) Descriptor() ([]byte, []int) {
	return file_harmonic_proto_auth_proto_rawDescGZIP(), []int{2}
}
...
type Token struct {
	...
	ExpiresAtUtc *timestamp.Timestamp `protobuf:"bytes,2,opt,name=expires_at_utc,json=expiresAtUtc,proto3" json:"expires_at_utc,omitempty"`
}

func (x *Token) Reset() {
	*x = Token{}
	if protoimpl.UnsafeEnabled {
		mi := &file_harmonic_proto_auth_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Token) Descriptor() ([]byte, []int) {
	return file_harmonic_proto_auth_proto_rawDescGZIP(), []int{3}
}
...
func (x *Token) GetExpiresAtUtc() *timestamp.Timestamp {
	if x != nil {
...
func (x *GenerateAuthTokensResponse) Reset() {
	*x = GenerateAuthTokensResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_harmonic_proto_auth_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GenerateAuthTokensResponse) Descriptor() ([]byte, []int) {
	return file_harmonic_proto_auth_proto_rawDescGZIP(), []int{4}
}
...
func (x *RefreshAccessTokenRequest) Reset() {
	*x = RefreshAccessTokenRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_harmonic_proto_auth_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RefreshAccessTokenRequest) Descriptor() ([]byte, []int) {
	return file_harmonic_proto_auth_proto_rawDescGZIP(), []int{5}
}
...
func (x *RefreshAccessTokenResponse) Reset() {
	*x = RefreshAccessTokenResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_harmonic_proto_auth_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RefreshAccessTokenResponse) Descriptor() ([]byte, []int) {
	return file_harmonic_proto_auth_proto_rawDescGZIP(), []int{6}
}
...
var File_harmonic_proto_auth_proto protoreflect.FileDescriptor

var file_harmonic_proto_auth_proto_rawDesc = []byte{
	0x0a, 0x19, 0x68, 0x61, 0x72, 0x6d, 0x6f, 0x6e, 0x69, 0x63, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x74, 0x6f, 0x22, 0x56, 0x0a, 0x1c, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x41, 0x75,
	...
	0x6c, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x06, 0x70, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x22, 0x3d, 0x0a, 0x1d, 0x47, 0x65,
	...
	0x63, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x22, 0x89, 0x01, 0x0a, 0x19, 0x47, 0x65,
	...
	,
	...
	,
	...
	0x61, 0x75, 0x74, 0x68, 0x2e, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x41, 0x75, 0x74,
	0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x00, 0x12, 0x59, 0x0a, 0x12, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x41, 0x63, 0x63, 0x65,
	0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x1f, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x52,
	...
	0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x40, 0x5a, 0x3e,
	...
	0x2d, 0x74, 0x72, 0x61, 0x64, 0x65, 0x72, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x68, 0x61,
	0x72, 0x6d, 0x6f, 0x6e, 0x69, 0x63, 0x2d, 0x67, 0x6f, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_harmonic_proto_auth_proto_rawDescOnce sync.Once
	file_harmonic_proto_auth_proto_rawDescData = file_harmonic_proto_auth_proto_rawDesc
)

func file_harmonic_proto_auth_proto_rawDescGZIP() []byte {
	file_harmonic_proto_auth_proto_rawDescOnce.Do(func() {
		file_harmonic_proto_auth_proto_rawDescData = protoimpl.X.CompressGZIP(file_harmonic_proto_auth_proto_rawDescData)
	})
	return file_harmonic_proto_auth_proto_rawDescData
}

var file_harmonic_proto_auth_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_harmonic_proto_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_harmonic_proto_auth_proto_goTypes = []interface{}{
	(Role)(0),                             // 0: auth.Role
...
var file_harmonic_proto_auth_proto_depIdxs = []int32{
...
func init() { file_harmonic_proto_auth_proto_init() }
func file_harmonic_proto_auth_proto_init() {
	if File_harmonic_proto_auth_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_harmonic_proto_auth_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_harmonic_proto_auth_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_harmonic_proto_auth_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_harmonic_proto_auth_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Token); i {
			case 0:
				return &v.state
			case 1:
		...
		file_harmonic_proto_auth_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_harmonic_proto_auth_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_harmonic_proto_auth_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_harmonic_proto_auth_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_harmonic_proto_auth_proto_goTypes,
		DependencyIndexes: file_harmonic_proto_auth_proto_depIdxs,
		EnumInfos:         file_harmonic_proto_auth_proto_enumTypes,
		MessageInfos:      file_harmonic_proto_auth_proto_msgTypes,
	}.Build()
	File_harmonic_proto_auth_proto = out.File
	file_harmonic_proto_auth_proto_rawDesc = nil
	file_harmonic_proto_auth_proto_goTypes = nil
	file_harmonic_proto_auth_proto_depIdxs = nil
}
