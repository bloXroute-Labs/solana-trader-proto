...
var file_api_proto_rawDesc = []byte{
	...
	0x4e, 0x42, 0x4f, 0x4f, 0x4b, 0x10, 0x05, 0x32, 0x99, 0x66, 0x0a, 0x03, 0x41, 0x70, 0x69, 0x12,
...
var file_api_proto_depIdxs = []int32{
	...
	35,  // 215: api.Api.PostOrder:input_type -> api.PostOrderRequest
	53,  // 216: api.Api.PostSubmit:input_type -> api.PostSubmitRequest
	55,  // 217: api.Api.PostSubmitBatch:input_type -> api.PostSubmitBatchRequest
	38,  // 218: api.Api.PostCancelOrder:input_type -> api.PostCancelOrderRequest
	39,  // 219: api.Api.PostCancelByClientOrderID:input_type -> api.PostCancelByClientOrderIDRequest
	41,  // 220: api.Api.PostCancelAll:input_type -> api.PostCancelAllRequest
	35,  // 221: api.Api.PostReplaceByClientOrderID:input_type -> api.PostOrderRequest
	36,  // 222: api.Api.PostReplaceOrder:input_type -> api.PostReplaceOrderRequest
	44,  // 223: api.Api.PostSettle:input_type -> api.PostSettleRequest
	79,  // 224: api.Api.PostTradeSwap:input_type -> api.TradeSwapRequest
	47,  // 225: api.Api.GetOrders:input_type -> api.GetOrdersRequest
	59,  // 226: api.Api.GetOpenOrders:input_type -> api.GetOpenOrdersRequest
	61,  // 227: api.Api.GetOrderByID:input_type -> api.GetOrderByIDRequest
	135, // 228: api.Api.GetBundleResultV2:input_type -> api.GetBundleResultRequest
	63,  // 229: api.Api.GetUnsettled:input_type -> api.GetUnsettledRequest
	89,  // 230: api.Api.PostRouteTradeSwap:input_type -> api.RouteTradeSwapRequest
	17,  // 231: api.Api.GetOrderbooksStream:input_type -> api.GetOrderbooksRequest
	21,  // 232: api.Api.GetMarketDepthsStream:input_type -> api.GetMarketDepthsRequest
	69,  // 233: api.Api.GetTickersStream:input_type -> api.GetTickersStreamRequest
	24,  // 234: api.Api.GetTradesStream:input_type -> api.GetTradesRequest
	50,  // 235: api.Api.GetOrderStatusStream:input_type -> api.GetOrderStatusStreamRequest
	103, // 236: api.Api.GetRecentBlockHashStream:input_type -> api.GetRecentBlockHashRequest
	106, // 237: api.Api.GetBlockStream:input_type -> api.GetBlockStreamRequest
	151, // 238: api.Api.GetPriorityFeeStream:input_type -> api.GetPriorityFeeRequest
	127, // 239: api.Api.GetQuotesStream:input_type -> api.GetQuotesStreamRequest
	148, // 240: api.Api.GetPoolReservesStream:input_type -> api.GetPoolReservesStreamRequest
	149, // 241: api.Api.GetPricesStream:input_type -> api.GetPricesStreamRequest
	132, // 242: api.Api.GetNewRaydiumPoolsStream:input_type -> api.GetNewRaydiumPoolsRequest
	130, // 243: api.Api.GetSwapsStream:input_type -> api.GetSwapsStreamRequest
	115, // 244: api.Api.GetRateLimit:output_type -> api.GetRateLimitResponse
	117, // 245: api.Api.GetTransaction:output_type -> api.GetTransactionResponse
	58,  // 246: api.Api.PostSubmitV2:output_type -> api.PostSubmitResponse
	57,  // 247: api.Api.PostSubmitBatchV2:output_type -> api.PostSubmitBatchResponse
	111, // 248: api.Api.GetRaydiumPools:output_type -> api.GetRaydiumPoolsResponse
	113, // 249: api.Api.GetRaydiumPoolReserve:output_type -> api.GetRaydiumPoolReserveResponse
	75,  // 250: api.Api.GetRaydiumQuotes:output_type -> api.GetRaydiumQuotesResponse
	142, // 251: api.Api.GetRaydiumPrices:output_type -> api.GetRaydiumPricesResponse
	85,  // 252: api.Api.PostRaydiumSwap:output_type -> api.PostRaydiumSwapResponse
	87,  // 253: api.Api.PostRaydiumRouteSwap:output_type -> api.PostRaydiumRouteSwapResponse
	77,  // 254: api.Api.GetJupiterQuotes:output_type -> api.GetJupiterQuotesResponse
	143, // 255: api.Api.GetJupiterPrices:output_type -> api.GetJupiterPricesResponse
	86,  // 256: api.Api.PostJupiterSwap:output_type -> api.PostJupiterSwapResponse
	83,  // 257: api.Api.PostJupiterSwapInstructions:output_type -> api.PostJupiterSwapInstructionsResponse
	88,  // 258: api.Api.PostJupiterRouteSwap:output_type -> api.PostJupiterRouteSwapResponse
	154, // 259: api.Api.GetMarketsV2:output_type -> api.GetMarketsResponseV2
	157, // 260: api.Api.GetTickersV2:output_type -> api.GetTickersResponseV2
	160, // 261: api.Api.GetOrderbookV2:output_type -> api.GetOrderbookResponseV2
	163, // 262: api.Api.GetMarketDepthV2:output_type -> api.GetMarketDepthResponseV2
	37,  // 263: api.Api.PostOrderV2:output_type -> api.PostOrderResponse
	168, // 264: api.Api.PostCancelOrderV2:output_type -> api.PostCancelOrderResponseV2
	37,  // 265: api.Api.PostReplaceOrderV2:output_type -> api.PostOrderResponse
	45,  // 266: api.Api.PostSettleV2:output_type -> api.PostSettleResponse
	172, // 267: api.Api.GetOpenOrdersV2:output_type -> api.GetOpenOrdersResponseV2
	66,  // 268: api.Api.GetUnsettledV2:output_type -> api.GetUnsettledResponse
	139, // 269: api.Api.GetPrice:output_type -> api.GetPriceResponse
	8,   // 270: api.Api.GetMarkets:output_type -> api.GetMarketsResponse
	109, // 271: api.Api.GetPools:output_type -> api.GetPoolsResponse
	...
	73,  // 277: api.Api.GetQuotes:output_type -> api.GetQuotesResponse
	28,  // 278: api.Api.GetServerTime:output_type -> api.GetServerTimeResponse
	104, // 279: api.Api.GetRecentBlockHash:output_type -> api.GetRecentBlockHashResponse
	152, // 280: api.Api.GetPriorityFee:output_type -> api.GetPriorityFeeResponse
	30,  // 281: api.Api.GetAccountBalance:output_type -> api.GetAccountBalanceResponse
	33,  // 282: api.Api.GetTokenAccounts:output_type -> api.GetTokenAccountsResponse
	37,  // 283: api.Api.PostOrder:output_type -> api.PostOrderResponse
	58,  // 284: api.Api.PostSubmit:output_type -> api.PostSubmitResponse
	57,  // 285: api.Api.PostSubmitBatch:output_type -> api.PostSubmitBatchResponse
	40,  // 286: api.Api.PostCancelOrder:output_type -> api.PostCancelOrderResponse
	40,  // 287: api.Api.PostCancelByClientOrderID:output_type -> api.PostCancelOrderResponse
	43,  // 288: api.Api.PostCancelAll:output_type -> api.PostCancelAllResponse
	37,  // 289: api.Api.PostReplaceByClientOrderID:output_type -> api.PostOrderResponse
	37,  // 290: api.Api.PostReplaceOrder:output_type -> api.PostOrderResponse
	45,  // 291: api.Api.PostSettle:output_type -> api.PostSettleResponse
	95,  // 292: api.Api.PostTradeSwap:output_type -> api.TradeSwapResponse
	48,  // 293: api.Api.GetOrders:output_type -> api.GetOrdersResponse
	60,  // 294: api.Api.GetOpenOrders:output_type -> api.GetOpenOrdersResponse
	62,  // 295: api.Api.GetOrderByID:output_type -> api.GetOrderByIDResponse
	136, // 296: api.Api.GetBundleResultV2:output_type -> api.GetBundleResultResponse
	66,  // 297: api.Api.GetUnsettled:output_type -> api.GetUnsettledResponse
	95,  // 298: api.Api.PostRouteTradeSwap:output_type -> api.TradeSwapResponse
	67,  // 299: api.Api.GetOrderbooksStream:output_type -> api.GetOrderbooksStreamResponse
	68,  // 300: api.Api.GetMarketDepthsStream:output_type -> api.GetMarketDepthsStreamResponse
	70,  // 301: api.Api.GetTickersStream:output_type -> api.GetTickersStreamResponse
	71,  // 302: api.Api.GetTradesStream:output_type -> api.GetTradesStreamResponse
	51,  // 303: api.Api.GetOrderStatusStream:output_type -> api.GetOrderStatusStreamResponse
	104, // 304: api.Api.GetRecentBlockHashStream:output_type -> api.GetRecentBlockHashResponse
	107, // 305: api.Api.GetBlockStream:output_type -> api.GetBlockStreamResponse
	152, // 306: api.Api.GetPriorityFeeStream:output_type -> api.GetPriorityFeeResponse
	128, // 307: api.Api.GetQuotesStream:output_type -> api.GetQuotesStreamResponse
	146, // 308: api.Api.GetPoolReservesStream:output_type -> api.GetPoolReservesStreamResponse
	150, // 309: api.Api.GetPricesStream:output_type -> api.GetPricesStreamResponse
	133, // 310: api.Api.GetNewRaydiumPoolsStream:output_type -> api.GetNewRaydiumPoolsResponse
	131, // 311: api.Api.GetSwapsStream:output_type -> api.GetSwapsStreamResponse
