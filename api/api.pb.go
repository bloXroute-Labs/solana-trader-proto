...
var file_api_proto_rawDesc = []byte{
	...
	0x72, 0x73, 0x22, 0x8d, 0x03, 0x0a, 0x09, 0x50, 0x65, 0x72, 0x70, 0x4f, 0x72, 0x64, 0x65, 0x72,
	...
	0x49, 0x44, 0x22, 0xc1, 0x01, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x50, 0x65, 0x72, 0x70, 0x50, 0x6f,
	...
	0x69, 0x65, 0x6e, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x44, 0x22, 0x52, 0x0a, 0x15, 0x50,
...
var file_api_proto_depIdxs = []int32{
	...
	156, // 153: api.GetNewPerpOrdersStreamResponse.contract:type_name -> common.PerpContract
	159, // 154: api.GetNewPerpOrdersStreamResponse.side:type_name -> common.PerpPositionSide
	160, // 155: api.GetNewPerpOrdersStreamResponse.type:type_name -> common.PerpOrderType
	156, // 156: api.GetPerpTradesStreamRequest.contracts:type_name -> common.PerpContract
	6,   // 157: api.GetPerpTradesStreamRequest.project:type_name -> api.Project
	136, // 158: api.GetPerpTradesStreamResponse.trade:type_name -> api.GetPerpTradesResponse
	156, // 159: api.GetPerpTradesResponse.contract:type_name -> common.PerpContract
	156, // 160: api.PostSettlePNLRequest.contract:type_name -> common.PerpContract
	...
	140, // 164: api.GetAssetsResponse.assets:type_name -> api.Asset
	156, // 165: api.PostSettlePNLsRequest.contract:type_name -> common.PerpContract
	...
	156, // 168: api.PostLiquidatePerpRequest.contract:type_name -> common.PerpContract
	...
	156, // 172: api.ContractInfo.contract:type_name -> common.PerpContract
	147, // 173: api.GetPerpContractsResponse.contracts:type_name -> api.ContractInfo
	156, // 174: api.GetOpenPerpOrderRequest.contract:type_name -> common.PerpContract
	6,   // 175: api.GetOpenPerpOrderRequest.project:type_name -> api.Project
	124, // 176: api.GetOpenPerpOrderResponse.order:type_name -> api.PerpOrder
	9,   // 177: api.GetMarketsResponse.MarketsEntry.value:type_name -> api.Market
	98,  // 178: api.Api.GetPrice:input_type -> api.GetPriceRequest
	7,   // 179: api.Api.GetMarkets:input_type -> api.GetMarketsRequest
	87,  // 180: api.Api.GetPools:input_type -> api.GetPoolsRequest
	10,  // 181: api.Api.GetTickers:input_type -> api.GetTickersRequest
	13,  // 182: api.Api.GetKline:input_type -> api.GetKlineRequest
	16,  // 183: api.Api.GetOrderbook:input_type -> api.GetOrderbookRequest
	20,  // 184: api.Api.GetMarketDepth:input_type -> api.GetMarketDepthRequest
	24,  // 185: api.Api.GetTrades:input_type -> api.GetTradesRequest
	72,  // 186: api.Api.GetQuotes:input_type -> api.GetQuotesRequest
	27,  // 187: api.Api.GetServerTime:input_type -> api.GetServerTimeRequest
	82,  // 188: api.Api.GetRecentBlockHash:input_type -> api.GetRecentBlockHashRequest
	29,  // 189: api.Api.GetAccountBalance:input_type -> api.GetAccountBalanceRequest
	32,  // 190: api.Api.GetTokenAccounts:input_type -> api.GetTokenAccountsRequest
	35,  // 191: api.Api.PostOrder:input_type -> api.PostOrderRequest
	54,  // 192: api.Api.PostSubmit:input_type -> api.PostSubmitRequest
	56,  // 193: api.Api.PostSubmitBatch:input_type -> api.PostSubmitBatchRequest
	38,  // 194: api.Api.PostCancelOrder:input_type -> api.PostCancelOrderRequest
	39,  // 195: api.Api.PostCancelByClientOrderID:input_type -> api.PostCancelByClientOrderIDRequest
	41,  // 196: api.Api.PostCancelAll:input_type -> api.PostCancelAllRequest
	35,  // 197: api.Api.PostReplaceByClientOrderID:input_type -> api.PostOrderRequest
	36,  // 198: api.Api.PostReplaceOrder:input_type -> api.PostReplaceOrderRequest
	44,  // 199: api.Api.PostSettle:input_type -> api.PostSettleRequest
	75,  // 200: api.Api.PostTradeSwap:input_type -> api.TradeSwapRequest
	47,  // 201: api.Api.GetOrders:input_type -> api.GetOrdersRequest
	60,  // 202: api.Api.GetOpenOrders:input_type -> api.GetOpenOrdersRequest
	62,  // 203: api.Api.GetOrderByID:input_type -> api.GetOrderByIDRequest
	64,  // 204: api.Api.GetUnsettled:input_type -> api.GetUnsettledRequest
	76,  // 205: api.Api.PostRouteTradeSwap:input_type -> api.RouteTradeSwapRequest
	130, // 206: api.Api.PostPerpOrder:input_type -> api.PostPerpOrderRequest
	125, // 207: api.Api.GetPerpPositions:input_type -> api.GetPerpPositionsRequest
	122, // 208: api.Api.GetOpenPerpOrders:input_type -> api.GetOpenPerpOrdersRequest
	116, // 209: api.Api.PostCancelPerpOrders:input_type -> api.PostCancelPerpOrdersRequest
	118, // 210: api.Api.PostCancelPerpOrder:input_type -> api.PostCancelPerpOrderRequest
	127, // 211: api.Api.PostClosePerpPositions:input_type -> api.PostClosePerpPositionsRequest
	106, // 212: api.Api.GetPerpOrderbook:input_type -> api.GetPerpOrderbookRequest
	114, // 213: api.Api.PostCreateUser:input_type -> api.PostCreateUserRequest
	111, // 214: api.Api.GetUser:input_type -> api.GetUserRequest
	120, // 215: api.Api.PostManageCollateral:input_type -> api.PostManageCollateralRequest
	137, // 216: api.Api.PostSettlePNL:input_type -> api.PostSettlePNLRequest
	142, // 217: api.Api.PostSettlePNLs:input_type -> api.PostSettlePNLsRequest
	139, // 218: api.Api.GetAssets:input_type -> api.GetAssetsRequest
	146, // 219: api.Api.GetPerpContracts:input_type -> api.GetPerpContractsRequest
	144, // 220: api.Api.PostLiquidatePerp:input_type -> api.PostLiquidatePerpRequest
	149, // 221: api.Api.GetOpenPerpOrder:input_type -> api.GetOpenPerpOrderRequest
	17,  // 222: api.Api.GetOrderbooksStream:input_type -> api.GetOrderbooksRequest
	21,  // 223: api.Api.GetMarketDepthsStream:input_type -> api.GetMarketDepthsRequest
	10,  // 224: api.Api.GetTickersStream:input_type -> api.GetTickersRequest
	24,  // 225: api.Api.GetTradesStream:input_type -> api.GetTradesRequest
	51,  // 226: api.Api.GetOrderStatusStream:input_type -> api.GetOrderStatusStreamRequest
	82,  // 227: api.Api.GetRecentBlockHashStream:input_type -> api.GetRecentBlockHashRequest
	85,  // 228: api.Api.GetBlockStream:input_type -> api.GetBlockStreamRequest
	91,  // 229: api.Api.GetQuotesStream:input_type -> api.GetQuotesStreamRequest
	103, // 230: api.Api.GetPoolReservesStream:input_type -> api.GetPoolReservesStreamRequest
	104, // 231: api.Api.GetPricesStream:input_type -> api.GetPricesStreamRequest
	94,  // 232: api.Api.GetSwapsStream:input_type -> api.GetSwapsStreamRequest
	107, // 233: api.Api.GetPerpOrderbooksStream:input_type -> api.GetPerpOrderbooksRequest
	132, // 234: api.Api.GetNewPerpOrdersStream:input_type -> api.GetNewPerpOrdersStreamRequest
	134, // 235: api.Api.GetPerpTradesStream:input_type -> api.GetPerpTradesStreamRequest
	99,  // 236: api.Api.GetPrice:output_type -> api.GetPriceResponse
	8,   // 237: api.Api.GetMarkets:output_type -> api.GetMarketsResponse
	88,  // 238: api.Api.GetPools:output_type -> api.GetPoolsResponse
	11,  // 239: api.Api.GetTickers:output_type -> api.GetTickersResponse
	14,  // 240: api.Api.GetKline:output_type -> api.GetKlineResponse
	18,  // 241: api.Api.GetOrderbook:output_type -> api.GetOrderbookResponse
	22,  // 242: api.Api.GetMarketDepth:output_type -> api.GetMarketDepthResponse
	25,  // 243: api.Api.GetTrades:output_type -> api.GetTradesResponse
	73,  // 244: api.Api.GetQuotes:output_type -> api.GetQuotesResponse
	28,  // 245: api.Api.GetServerTime:output_type -> api.GetServerTimeResponse
	83,  // 246: api.Api.GetRecentBlockHash:output_type -> api.GetRecentBlockHashResponse
	30,  // 247: api.Api.GetAccountBalance:output_type -> api.GetAccountBalanceResponse
	33,  // 248: api.Api.GetTokenAccounts:output_type -> api.GetTokenAccountsResponse
	37,  // 249: api.Api.PostOrder:output_type -> api.PostOrderResponse
	57,  // 250: api.Api.PostSubmit:output_type -> api.PostSubmitResponse
	59,  // 251: api.Api.PostSubmitBatch:output_type -> api.PostSubmitBatchResponse
	40,  // 252: api.Api.PostCancelOrder:output_type -> api.PostCancelOrderResponse
	40,  // 253: api.Api.PostCancelByClientOrderID:output_type -> api.PostCancelOrderResponse
	43,  // 254: api.Api.PostCancelAll:output_type -> api.PostCancelAllResponse
	37,  // 255: api.Api.PostReplaceByClientOrderID:output_type -> api.PostOrderResponse
	37,  // 256: api.Api.PostReplaceOrder:output_type -> api.PostOrderResponse
	45,  // 257: api.Api.PostSettle:output_type -> api.PostSettleResponse
	78,  // 258: api.Api.PostTradeSwap:output_type -> api.TradeSwapResponse
	48,  // 259: api.Api.GetOrders:output_type -> api.GetOrdersResponse
	61,  // 260: api.Api.GetOpenOrders:output_type -> api.GetOpenOrdersResponse
	63,  // 261: api.Api.GetOrderByID:output_type -> api.GetOrderByIDResponse
	67,  // 262: api.Api.GetUnsettled:output_type -> api.GetUnsettledResponse
	78,  // 263: api.Api.PostRouteTradeSwap:output_type -> api.TradeSwapResponse
	131, // 264: api.Api.PostPerpOrder:output_type -> api.PostPerpOrderResponse
	126, // 265: api.Api.GetPerpPositions:output_type -> api.GetPerpPositionsResponse
	123, // 266: api.Api.GetOpenPerpOrders:output_type -> api.GetOpenPerpOrdersResponse
	117, // 267: api.Api.PostCancelPerpOrders:output_type -> api.PostCancelPerpOrdersResponse
	119, // 268: api.Api.PostCancelPerpOrder:output_type -> api.PostCancelPerpOrderResponse
	128, // 269: api.Api.PostClosePerpPositions:output_type -> api.PostClosePerpPositionsResponse
	108, // 270: api.Api.GetPerpOrderbook:output_type -> api.GetPerpOrderbookResponse
	115, // 271: api.Api.PostCreateUser:output_type -> api.PostCreateUserResponse
	112, // 272: api.Api.GetUser:output_type -> api.GetUserResponse
	121, // 273: api.Api.PostManageCollateral:output_type -> api.PostManageCollateralResponse
	138, // 274: api.Api.PostSettlePNL:output_type -> api.PostSettlePNLResponse
	143, // 275: api.Api.PostSettlePNLs:output_type -> api.PostSettlePNLsResponse
	141, // 276: api.Api.GetAssets:output_type -> api.GetAssetsResponse
	148, // 277: api.Api.GetPerpContracts:output_type -> api.GetPerpContractsResponse
	145, // 278: api.Api.PostLiquidatePerp:output_type -> api.PostLiquidatePerpResponse
	150, // 279: api.Api.GetOpenPerpOrder:output_type -> api.GetOpenPerpOrderResponse
	68,  // 280: api.Api.GetOrderbooksStream:output_type -> api.GetOrderbooksStreamResponse
	69,  // 281: api.Api.GetMarketDepthsStream:output_type -> api.GetMarketDepthsStreamResponse
	70,  // 282: api.Api.GetTickersStream:output_type -> api.GetTickersStreamResponse
	71,  // 283: api.Api.GetTradesStream:output_type -> api.GetTradesStreamResponse
	52,  // 284: api.Api.GetOrderStatusStream:output_type -> api.GetOrderStatusStreamResponse
	83,  // 285: api.Api.GetRecentBlockHashStream:output_type -> api.GetRecentBlockHashResponse
	86,  // 286: api.Api.GetBlockStream:output_type -> api.GetBlockStreamResponse
	92,  // 287: api.Api.GetQuotesStream:output_type -> api.GetQuotesStreamResponse
	101, // 288: api.Api.GetPoolReservesStream:output_type -> api.GetPoolReservesStreamResponse
	105, // 289: api.Api.GetPricesStream:output_type -> api.GetPricesStreamResponse
	95,  // 290: api.Api.GetSwapsStream:output_type -> api.GetSwapsStreamResponse
	110, // 291: api.Api.GetPerpOrderbooksStream:output_type -> api.GetPerpOrderbooksStreamResponse
	133, // 292: api.Api.GetNewPerpOrdersStream:output_type -> api.GetNewPerpOrdersStreamResponse
	135, // 293: api.Api.GetPerpTradesStream:output_type -> api.GetPerpTradesStreamResponse
