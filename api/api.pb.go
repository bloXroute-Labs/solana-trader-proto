...
var file_api_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x65, 0x72, 0x52, 0x06, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x22, 0x8d, 0x03, 0x0a,
	...
	0x73, 0x75, 0x62, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x44, 0x22, 0xc1, 0x01, 0x0a,
	...
	0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x44, 0x22, 0xb9, 0x03, 0x0a, 0x14, 0x50, 0x6f,
	...
	0x73, 0x73, 0x12, 0x30, 0x0a, 0x08, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x18, 0x04,
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x3c, 0x0a, 0x0c,
	...
	0x69, 0x70, 0x70, 0x61, 0x67, 0x65, 0x12, 0x29, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x08,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x15, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x50, 0x65,
	0x72, 0x70, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70,
	...
	0x18, 0x0b, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0d, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x49, 0x44, 0x22, 0x52, 0x0a, 0x15, 0x50, 0x6f, 0x73, 0x74, 0x50, 0x65, 0x72,
	...
	0x06, 0x32, 0x86, 0x56, 0x0a, 0x03, 0x41, 0x70, 0x69, 0x12, 0xaa, 0x01, 0x0a, 0x08, 0x47, 0x65,
	...
	0x12, 0xe5, 0x01, 0x0a, 0x11, 0x50, 0x6f, 0x73, 0x74, 0x4c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x61,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x90, 0x01, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x21, 0x22, 0x1c,
	...
	0x41, 0x66, 0x0a, 0x04, 0x50, 0x65, 0x72, 0x70, 0x12, 0x18, 0x6c, 0x69, 0x71, 0x75, 0x69, 0x64,
	...
	0x31, 0x2e, 0x31, 0x32, 0x10, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
...
var file_api_proto_goTypes = []interface{}{
	...
	(*GetPerpTradesResponse)(nil),            // 135: api.GetPerpTradesResponse
	(*PostSettlePNLRequest)(nil),             // 136: api.PostSettlePNLRequest
	(*PostSettlePNLResponse)(nil),            // 137: api.PostSettlePNLResponse
	(*GetAssetsRequest)(nil),                 // 138: api.GetAssetsRequest
	(*Asset)(nil),                            // 139: api.Asset
	(*GetAssetsResponse)(nil),                // 140: api.GetAssetsResponse
	(*PostSettlePNLsRequest)(nil),            // 141: api.PostSettlePNLsRequest
	(*PostSettlePNLsResponse)(nil),           // 142: api.PostSettlePNLsResponse
	(*PostLiquidatePerpRequest)(nil),         // 143: api.PostLiquidatePerpRequest
	(*PostLiquidatePerpResponse)(nil),        // 144: api.PostLiquidatePerpResponse
	(*GetPerpContractsRequest)(nil),          // 145: api.GetPerpContractsRequest
	(*ContractInfo)(nil),                     // 146: api.ContractInfo
	(*GetPerpContractsResponse)(nil),         // 147: api.GetPerpContractsResponse
	(*GetOpenPerpOrderRequest)(nil),          // 148: api.GetOpenPerpOrderRequest
	(*GetOpenPerpOrderResponse)(nil),         // 149: api.GetOpenPerpOrderResponse
	nil,                                      // 150: api.GetMarketsResponse.MarketsEntry
	(*timestamp.Timestamp)(nil),              // 151: google.protobuf.Timestamp
	(common.OrderType)(0),                    // 152: common.OrderType
	(*common.PriceImpactPercent)(nil),        // 153: common.PriceImpactPercent
	(*common.Fee)(nil),                       // 154: common.Fee
	(common.PerpContract)(0),                 // 155: common.PerpContract
	(common.PerpCollateralType)(0),           // 156: common.PerpCollateralType
	(common.PerpCollateralToken)(0),          // 157: common.PerpCollateralToken
	(common.PerpPositionSide)(0),             // 158: common.PerpPositionSide
	(common.PerpOrderType)(0),                // 159: common.PerpOrderType
}
var file_api_proto_depIdxs = []int32{
	150, // 0: api.GetMarketsResponse.markets:type_name -> api.GetMarketsResponse.MarketsEntry
	...
	151, // 6: api.GetKlineRequest.from:type_name -> google.protobuf.Timestamp
	151, // 7: api.GetKlineRequest.to:type_name -> google.protobuf.Timestamp
	151, // 8: api.GetKlineResponse.timestamp:type_name -> google.protobuf.Timestamp
	15,  // 9: api.GetKlineResponse.candles:type_name -> api.Candle
	151, // 10: api.Candle.startTime:type_name -> google.protobuf.Timestamp
	151, // 11: api.Candle.updateTime:type_name -> google.protobuf.Timestamp
	...
	152, // 26: api.PostOrderRequest.type:type_name -> common.OrderType
	6,   // 27: api.PostOrderRequest.project:type_name -> api.Project
	1,   // 28: api.PostReplaceOrderRequest.side:type_name -> api.Side
	152, // 29: api.PostReplaceOrderRequest.type:type_name -> common.OrderType
	...
	152, // 42: api.GetOrdersRequest.types:type_name -> common.OrderType
	151, // 43: api.GetOrdersRequest.from:type_name -> google.protobuf.Timestamp
	...
	152, // 48: api.Order.types:type_name -> common.OrderType
	151, // 49: api.Order.createdAt:type_name -> google.protobuf.Timestamp
	...
	153, // 81: api.TradeSwapResponse.priceImpact:type_name -> common.PriceImpactPercent
	154, // 82: api.TradeSwapResponse.fees:type_name -> common.Fee
	79,  // 83: api.QuoteRoute.steps:type_name -> api.QuoteStep
	80,  // 84: api.QuoteStep.project:type_name -> api.StepProject
	153, // 85: api.QuoteStep.priceImpactPercent:type_name -> common.PriceImpactPercent
	154, // 86: api.QuoteStep.fee:type_name -> common.Fee
	...
	155, // 106: api.GetPerpOrderbookRequest.contract:type_name -> common.PerpContract
	6,   // 107: api.GetPerpOrderbookRequest.project:type_name -> api.Project
	155, // 108: api.GetPerpOrderbooksRequest.contracts:type_name -> common.PerpContract
	6,   // 109: api.GetPerpOrderbooksRequest.project:type_name -> api.Project
	155, // 110: api.GetPerpOrderbookResponse.contract:type_name -> common.PerpContract
	...
	155, // 121: api.PostCancelPerpOrdersRequest.contract:type_name -> common.PerpContract
	...
	155, // 124: api.PostCancelPerpOrderRequest.contract:type_name -> common.PerpContract
	...
	156, // 127: api.PostManageCollateralRequest.type:type_name -> common.PerpCollateralType
	157, // 128: api.PostManageCollateralRequest.token:type_name -> common.PerpCollateralToken
	...
	155, // 131: api.GetOpenPerpOrdersRequest.contracts:type_name -> common.PerpContract
	123, // 132: api.GetOpenPerpOrdersResponse.orders:type_name -> api.PerpOrder
	155, // 133: api.PerpOrder.contract:type_name -> common.PerpContract
	158, // 134: api.PerpOrder.positionSide:type_name -> common.PerpPositionSide
	6,   // 135: api.GetPerpPositionsRequest.project:type_name -> api.Project
	155, // 136: api.GetPerpPositionsRequest.contracts:type_name -> common.PerpContract
	...
	155, // 139: api.PostClosePerpPositionsRequest.contracts:type_name -> common.PerpContract
	42,  // 140: api.PostClosePerpPositionsResponse.transactions:type_name -> api.TransactionMessage
	155, // 141: api.PerpPosition.contract:type_name -> common.PerpContract
	158, // 142: api.PerpPosition.positionSide:type_name -> common.PerpPositionSide
	6,   // 143: api.PostPerpOrderRequest.project:type_name -> api.Project
	155, // 144: api.PostPerpOrderRequest.contract:type_name -> common.PerpContract
	158, // 145: api.PostPerpOrderRequest.positionSide:type_name -> common.PerpPositionSide
	159, // 146: api.PostPerpOrderRequest.type:type_name -> common.PerpOrderType
	...
	155, // 149: api.GetNewPerpOrdersStreamResponse.contract:type_name -> common.PerpContract
	158, // 150: api.GetNewPerpOrdersStreamResponse.side:type_name -> common.PerpPositionSide
	159, // 151: api.GetNewPerpOrdersStreamResponse.type:type_name -> common.PerpOrderType
	155, // 152: api.GetPerpTradesStreamRequest.contracts:type_name -> common.PerpContract
	6,   // 153: api.GetPerpTradesStreamRequest.project:type_name -> api.Project
	135, // 154: api.GetPerpTradesStreamResponse.trade:type_name -> api.GetPerpTradesResponse
	155, // 155: api.GetPerpTradesResponse.contract:type_name -> common.PerpContract
	155, // 156: api.PostSettlePNLRequest.contract:type_name -> common.PerpContract
	6,   // 157: api.PostSettlePNLRequest.project:type_name -> api.Project
	42,  // 158: api.PostSettlePNLResponse.transaction:type_name -> api.TransactionMessage
	6,   // 159: api.GetAssetsRequest.project:type_name -> api.Project
	139, // 160: api.GetAssetsResponse.assets:type_name -> api.Asset
	155, // 161: api.PostSettlePNLsRequest.contract:type_name -> common.PerpContract
	6,   // 162: api.PostSettlePNLsRequest.project:type_name -> api.Project
	42,  // 163: api.PostSettlePNLsResponse.transactions:type_name -> api.TransactionMessage
	155, // 164: api.PostLiquidatePerpRequest.contract:type_name -> common.PerpContract
	6,   // 165: api.PostLiquidatePerpRequest.project:type_name -> api.Project
	42,  // 166: api.PostLiquidatePerpResponse.transaction:type_name -> api.TransactionMessage
	6,   // 167: api.GetPerpContractsRequest.project:type_name -> api.Project
	155, // 168: api.ContractInfo.contract:type_name -> common.PerpContract
	146, // 169: api.GetPerpContractsResponse.contracts:type_name -> api.ContractInfo
	155, // 170: api.GetOpenPerpOrderRequest.contract:type_name -> common.PerpContract
	...
	136, // 212: api.Api.PostSettlePNL:input_type -> api.PostSettlePNLRequest
	141, // 213: api.Api.PostSettlePNLs:input_type -> api.PostSettlePNLsRequest
	138, // 214: api.Api.GetAssets:input_type -> api.GetAssetsRequest
	145, // 215: api.Api.GetPerpContracts:input_type -> api.GetPerpContractsRequest
	143, // 216: api.Api.PostLiquidatePerp:input_type -> api.PostLiquidatePerpRequest
	148, // 217: api.Api.GetOpenPerpOrder:input_type -> api.GetOpenPerpOrderRequest
	...
	137, // 270: api.Api.PostSettlePNL:output_type -> api.PostSettlePNLResponse
	142, // 271: api.Api.PostSettlePNLs:output_type -> api.PostSettlePNLsResponse
	140, // 272: api.Api.GetAssets:output_type -> api.GetAssetsResponse
	147, // 273: api.Api.GetPerpContracts:output_type -> api.GetPerpContractsResponse
	144, // 274: api.Api.PostLiquidatePerp:output_type -> api.PostLiquidatePerpResponse
	149, // 275: api.Api.GetOpenPerpOrder:output_type -> api.GetOpenPerpOrderResponse
