...
var file_api_proto_rawDesc = []byte{
	...
	0x44, 0x52, 0x49, 0x46, 0x54, 0x10, 0x06, 0x32, 0x93, 0x59, 0x0a, 0x03, 0x41, 0x70, 0x69, 0x12,
	...
	0x6f, 0x75, 0x74, 0x65, 0x12, 0xb3, 0x01, 0x0a, 0x0f, 0x50, 0x6f, 0x73, 0x74, 0x4d, 0x61, 0x72,
	0x67, 0x69, 0x6e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x1b, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x50,
	...
	0x6e, 0x73, 0x65, 0x22, 0x65, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x1f, 0x22, 0x1a, 0x2f, 0x61, 0x70,
	0x69, 0x2f, 0x76, 0x31, 0x2f, 0x74, 0x72, 0x61, 0x64, 0x65, 0x2f, 0x6d, 0x61, 0x72, 0x67, 0x69,
	0x6e, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x3a, 0x01, 0x2a, 0x92, 0x41, 0x3d, 0x0a, 0x05, 0x54,
	0x72, 0x61, 0x64, 0x65, 0x0a, 0x06, 0x4d, 0x61, 0x72, 0x67, 0x69, 0x6e, 0x0a, 0x09, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x62, 0x6f, 0x6f, 0x6b, 0x12, 0x0c, 0x6d, 0x61, 0x72, 0x67, 0x69, 0x6e, 0x20,
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x1a, 0x13, 0x70, 0x6f, 0x73, 0x74, 0x20, 0x61, 0x20, 0x6d, 0x61,
	0x72, 0x67, 0x69, 0x6e, 0x20, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x12, 0xa5, 0x01, 0x0a, 0x0d, 0x50,
...
var file_api_proto_depIdxs = []int32{
	...
	23,  // 191: api.Api.GetMarketDepth:input_type -> api.GetMarketDepthRequest
	27,  // 192: api.Api.GetTrades:input_type -> api.GetTradesRequest
	74,  // 193: api.Api.GetQuotes:input_type -> api.GetQuotesRequest
	30,  // 194: api.Api.GetServerTime:input_type -> api.GetServerTimeRequest
	84,  // 195: api.Api.GetRecentBlockHash:input_type -> api.GetRecentBlockHashRequest
	32,  // 196: api.Api.GetAccountBalance:input_type -> api.GetAccountBalanceRequest
	35,  // 197: api.Api.GetTokenAccounts:input_type -> api.GetTokenAccountsRequest
	38,  // 198: api.Api.PostOrder:input_type -> api.PostOrderRequest
	56,  // 199: api.Api.PostSubmit:input_type -> api.PostSubmitRequest
	58,  // 200: api.Api.PostSubmitBatch:input_type -> api.PostSubmitBatchRequest
	41,  // 201: api.Api.PostCancelOrder:input_type -> api.PostCancelOrderRequest
	42,  // 202: api.Api.PostCancelByClientOrderID:input_type -> api.PostCancelByClientOrderIDRequest
	44,  // 203: api.Api.PostCancelAll:input_type -> api.PostCancelAllRequest
	38,  // 204: api.Api.PostReplaceByClientOrderID:input_type -> api.PostOrderRequest
	39,  // 205: api.Api.PostReplaceOrder:input_type -> api.PostReplaceOrderRequest
	47,  // 206: api.Api.PostSettle:input_type -> api.PostSettleRequest
	77,  // 207: api.Api.PostTradeSwap:input_type -> api.TradeSwapRequest
	50,  // 208: api.Api.GetOrders:input_type -> api.GetOrdersRequest
	62,  // 209: api.Api.GetOpenOrders:input_type -> api.GetOpenOrdersRequest
	64,  // 210: api.Api.GetOrderByID:input_type -> api.GetOrderByIDRequest
	66,  // 211: api.Api.GetUnsettled:input_type -> api.GetUnsettledRequest
	78,  // 212: api.Api.PostRouteTradeSwap:input_type -> api.RouteTradeSwapRequest
	134, // 213: api.Api.PostMarginOrder:input_type -> api.PostMarginOrderRequest
	132, // 214: api.Api.PostPerpOrder:input_type -> api.PostPerpOrderRequest
	127, // 215: api.Api.GetPerpPositions:input_type -> api.GetPerpPositionsRequest
	124, // 216: api.Api.GetOpenPerpOrders:input_type -> api.GetOpenPerpOrdersRequest
	118, // 217: api.Api.PostCancelPerpOrders:input_type -> api.PostCancelPerpOrdersRequest
	120, // 218: api.Api.PostCancelPerpOrder:input_type -> api.PostCancelPerpOrderRequest
	129, // 219: api.Api.PostClosePerpPositions:input_type -> api.PostClosePerpPositionsRequest
	108, // 220: api.Api.GetPerpOrderbook:input_type -> api.GetPerpOrderbookRequest
	116, // 221: api.Api.PostCreateUser:input_type -> api.PostCreateUserRequest
	113, // 222: api.Api.GetUser:input_type -> api.GetUserRequest
	122, // 223: api.Api.PostManageCollateral:input_type -> api.PostManageCollateralRequest
	141, // 224: api.Api.PostSettlePNL:input_type -> api.PostSettlePNLRequest
	146, // 225: api.Api.PostSettlePNLs:input_type -> api.PostSettlePNLsRequest
	143, // 226: api.Api.GetAssets:input_type -> api.GetAssetsRequest
	150, // 227: api.Api.GetPerpContracts:input_type -> api.GetPerpContractsRequest
	148, // 228: api.Api.PostLiquidatePerp:input_type -> api.PostLiquidatePerpRequest
	153, // 229: api.Api.GetOpenPerpOrder:input_type -> api.GetOpenPerpOrderRequest
	20,  // 230: api.Api.GetOrderbooksStream:input_type -> api.GetOrderbooksRequest
	24,  // 231: api.Api.GetMarketDepthsStream:input_type -> api.GetMarketDepthsRequest
	13,  // 232: api.Api.GetTickersStream:input_type -> api.GetTickersRequest
	27,  // 233: api.Api.GetTradesStream:input_type -> api.GetTradesRequest
	53,  // 234: api.Api.GetOrderStatusStream:input_type -> api.GetOrderStatusStreamRequest
	84,  // 235: api.Api.GetRecentBlockHashStream:input_type -> api.GetRecentBlockHashRequest
	87,  // 236: api.Api.GetBlockStream:input_type -> api.GetBlockStreamRequest
	93,  // 237: api.Api.GetQuotesStream:input_type -> api.GetQuotesStreamRequest
	105, // 238: api.Api.GetPoolReservesStream:input_type -> api.GetPoolReservesStreamRequest
	106, // 239: api.Api.GetPricesStream:input_type -> api.GetPricesStreamRequest
	96,  // 240: api.Api.GetSwapsStream:input_type -> api.GetSwapsStreamRequest
	109, // 241: api.Api.GetPerpOrderbooksStream:input_type -> api.GetPerpOrderbooksRequest
	136, // 242: api.Api.GetNewPerpOrdersStream:input_type -> api.GetNewPerpOrdersStreamRequest
	138, // 243: api.Api.GetPerpTradesStream:input_type -> api.GetPerpTradesStreamRequest
	101, // 244: api.Api.GetPrice:output_type -> api.GetPriceResponse
	9,   // 245: api.Api.GetMarkets:output_type -> api.GetMarketsResponse
	10,  // 246: api.Api.GetMarketsV2:output_type -> api.GetMarketsResponseV2
	90,  // 247: api.Api.GetPools:output_type -> api.GetPoolsResponse
	14,  // 248: api.Api.GetTickers:output_type -> api.GetTickersResponse
	17,  // 249: api.Api.GetKline:output_type -> api.GetKlineResponse
	21,  // 250: api.Api.GetOrderbook:output_type -> api.GetOrderbookResponse
	25,  // 251: api.Api.GetMarketDepth:output_type -> api.GetMarketDepthResponse
	28,  // 252: api.Api.GetTrades:output_type -> api.GetTradesResponse
	75,  // 253: api.Api.GetQuotes:output_type -> api.GetQuotesResponse
	31,  // 254: api.Api.GetServerTime:output_type -> api.GetServerTimeResponse
	85,  // 255: api.Api.GetRecentBlockHash:output_type -> api.GetRecentBlockHashResponse
	33,  // 256: api.Api.GetAccountBalance:output_type -> api.GetAccountBalanceResponse
	36,  // 257: api.Api.GetTokenAccounts:output_type -> api.GetTokenAccountsResponse
	40,  // 258: api.Api.PostOrder:output_type -> api.PostOrderResponse
	59,  // 259: api.Api.PostSubmit:output_type -> api.PostSubmitResponse
	61,  // 260: api.Api.PostSubmitBatch:output_type -> api.PostSubmitBatchResponse
	43,  // 261: api.Api.PostCancelOrder:output_type -> api.PostCancelOrderResponse
	43,  // 262: api.Api.PostCancelByClientOrderID:output_type -> api.PostCancelOrderResponse
	46,  // 263: api.Api.PostCancelAll:output_type -> api.PostCancelAllResponse
	40,  // 264: api.Api.PostReplaceByClientOrderID:output_type -> api.PostOrderResponse
	40,  // 265: api.Api.PostReplaceOrder:output_type -> api.PostOrderResponse
	48,  // 266: api.Api.PostSettle:output_type -> api.PostSettleResponse
	80,  // 267: api.Api.PostTradeSwap:output_type -> api.TradeSwapResponse
	51,  // 268: api.Api.GetOrders:output_type -> api.GetOrdersResponse
	63,  // 269: api.Api.GetOpenOrders:output_type -> api.GetOpenOrdersResponse
	65,  // 270: api.Api.GetOrderByID:output_type -> api.GetOrderByIDResponse
	69,  // 271: api.Api.GetUnsettled:output_type -> api.GetUnsettledResponse
	80,  // 272: api.Api.PostRouteTradeSwap:output_type -> api.TradeSwapResponse
	135, // 273: api.Api.PostMarginOrder:output_type -> api.PostMarginOrderResponse
	133, // 274: api.Api.PostPerpOrder:output_type -> api.PostPerpOrderResponse
	128, // 275: api.Api.GetPerpPositions:output_type -> api.GetPerpPositionsResponse
	125, // 276: api.Api.GetOpenPerpOrders:output_type -> api.GetOpenPerpOrdersResponse
	119, // 277: api.Api.PostCancelPerpOrders:output_type -> api.PostCancelPerpOrdersResponse
	121, // 278: api.Api.PostCancelPerpOrder:output_type -> api.PostCancelPerpOrderResponse
	130, // 279: api.Api.PostClosePerpPositions:output_type -> api.PostClosePerpPositionsResponse
	110, // 280: api.Api.GetPerpOrderbook:output_type -> api.GetPerpOrderbookResponse
	117, // 281: api.Api.PostCreateUser:output_type -> api.PostCreateUserResponse
	114, // 282: api.Api.GetUser:output_type -> api.GetUserResponse
	123, // 283: api.Api.PostManageCollateral:output_type -> api.PostManageCollateralResponse
	142, // 284: api.Api.PostSettlePNL:output_type -> api.PostSettlePNLResponse
	147, // 285: api.Api.PostSettlePNLs:output_type -> api.PostSettlePNLsResponse
	145, // 286: api.Api.GetAssets:output_type -> api.GetAssetsResponse
	152, // 287: api.Api.GetPerpContracts:output_type -> api.GetPerpContractsResponse
	149, // 288: api.Api.PostLiquidatePerp:output_type -> api.PostLiquidatePerpResponse
	154, // 289: api.Api.GetOpenPerpOrder:output_type -> api.GetOpenPerpOrderResponse
	70,  // 290: api.Api.GetOrderbooksStream:output_type -> api.GetOrderbooksStreamResponse
	71,  // 291: api.Api.GetMarketDepthsStream:output_type -> api.GetMarketDepthsStreamResponse
	72,  // 292: api.Api.GetTickersStream:output_type -> api.GetTickersStreamResponse
	73,  // 293: api.Api.GetTradesStream:output_type -> api.GetTradesStreamResponse
	54,  // 294: api.Api.GetOrderStatusStream:output_type -> api.GetOrderStatusStreamResponse
	85,  // 295: api.Api.GetRecentBlockHashStream:output_type -> api.GetRecentBlockHashResponse
	88,  // 296: api.Api.GetBlockStream:output_type -> api.GetBlockStreamResponse
	94,  // 297: api.Api.GetQuotesStream:output_type -> api.GetQuotesStreamResponse
	103, // 298: api.Api.GetPoolReservesStream:output_type -> api.GetPoolReservesStreamResponse
	107, // 299: api.Api.GetPricesStream:output_type -> api.GetPricesStreamResponse
	97,  // 300: api.Api.GetSwapsStream:output_type -> api.GetSwapsStreamResponse
	112, // 301: api.Api.GetPerpOrderbooksStream:output_type -> api.GetPerpOrderbooksStreamResponse
	137, // 302: api.Api.GetNewPerpOrdersStream:output_type -> api.GetNewPerpOrdersStreamResponse
	139, // 303: api.Api.GetPerpTradesStream:output_type -> api.GetPerpTradesStreamResponse
	244, // [244:304] is the sub-list for method output_type
	184, // [184:244] is the sub-list for method input_type
