...
type PostPerpOrderRequest struct {
	...
	Contract       Contract `protobuf:"varint,4,opt,name=contract,proto3,enum=api.Contract" json:"contract,omitempty"`
...
var file_api_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x22, 0x81, 0x03, 0x0a, 0x14, 0x50, 0x6f, 0x73, 0x74, 0x50, 0x65, 0x72, 0x70,
	...
	0x70, 0x61, 0x79, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x29, 0x0a, 0x08,
	0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x52, 0x08, 0x63,
	...
	0x49, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0x61, 0x0a, 0x15, 0x50, 0x6f, 0x73, 0x74, 0x50,
	...
	0x44, 0x52, 0x49, 0x46, 0x54, 0x10, 0x06, 0x2a, 0x3d, 0x0a, 0x08, 0x43, 0x6f, 0x6e, 0x74, 0x72,
	0x61, 0x63, 0x74, 0x12, 0x07, 0x0a, 0x03, 0x41, 0x4c, 0x4c, 0x10, 0x00, 0x12, 0x0c, 0x0a, 0x08,
	0x53, 0x4f, 0x4c, 0x5f, 0x50, 0x45, 0x52, 0x50, 0x10, 0x01, 0x12, 0x0c, 0x0a, 0x08, 0x45, 0x54,
	0x48, 0x5f, 0x50, 0x45, 0x52, 0x50, 0x10, 0x02, 0x12, 0x0c, 0x0a, 0x08, 0x42, 0x54, 0x43, 0x5f,
	0x50, 0x45, 0x52, 0x50, 0x10, 0x03, 0x32, 0x8c, 0x37, 0x0a, 0x03, 0x41, 0x70, 0x69, 0x12, 0xaa,
	...
	0x61, 0x20, 0x70, 0x65, 0x72, 0x70, 0x20, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x12, 0xd8, 0x01, 0x0a,
	0x17, 0x47, 0x65, 0x74, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x50, 0x65, 0x72, 0x70, 0x50,
	0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x23, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x47,
	0x65, 0x74, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x50, 0x65, 0x72, 0x70, 0x50, 0x6f, 0x73,
	...
	0x6e, 0x73, 0x65, 0x22, 0x72, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x1e, 0x12, 0x1c, 0x2f, 0x61, 0x70,
	0x69, 0x2f, 0x76, 0x31, 0x2f, 0x74, 0x72, 0x61, 0x64, 0x65, 0x2f, 0x70, 0x65, 0x72, 0x70, 0x2d,
	0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x92, 0x41, 0x4b, 0x0a, 0x05, 0x54, 0x72,
	0x61, 0x64, 0x65, 0x0a, 0x09, 0x55, 0x6e, 0x69, 0x76, 0x65, 0x72, 0x73, 0x61, 0x6c, 0x12, 0x0e,
...
var file_api_proto_depIdxs = []int32{
	...
	8,   // 110: api.PostPerpOrderRequest.contract:type_name -> api.Contract
	11,  // 111: api.GetMarketsResponse.MarketsEntry.value:type_name -> api.Market
	96,  // 112: api.Api.GetPrice:input_type -> api.GetPriceRequest
	9,   // 113: api.Api.GetMarkets:input_type -> api.GetMarketsRequest
	85,  // 114: api.Api.GetPools:input_type -> api.GetPoolsRequest
	12,  // 115: api.Api.GetTickers:input_type -> api.GetTickersRequest
	15,  // 116: api.Api.GetKline:input_type -> api.GetKlineRequest
	18,  // 117: api.Api.GetOrderbook:input_type -> api.GetOrderbookRequest
	22,  // 118: api.Api.GetMarketDepth:input_type -> api.GetMarketDepthRequest
	26,  // 119: api.Api.GetTrades:input_type -> api.GetTradesRequest
	70,  // 120: api.Api.GetQuotes:input_type -> api.GetQuotesRequest
	29,  // 121: api.Api.GetServerTime:input_type -> api.GetServerTimeRequest
	80,  // 122: api.Api.GetRecentBlockHash:input_type -> api.GetRecentBlockHashRequest
	31,  // 123: api.Api.GetAccountBalance:input_type -> api.GetAccountBalanceRequest
	34,  // 124: api.Api.PostOrder:input_type -> api.PostOrderRequest
	52,  // 125: api.Api.PostSubmit:input_type -> api.PostSubmitRequest
	54,  // 126: api.Api.PostSubmitBatch:input_type -> api.PostSubmitBatchRequest
	37,  // 127: api.Api.PostCancelOrder:input_type -> api.PostCancelOrderRequest
	38,  // 128: api.Api.PostCancelByClientOrderID:input_type -> api.PostCancelByClientOrderIDRequest
	40,  // 129: api.Api.PostCancelAll:input_type -> api.PostCancelAllRequest
	34,  // 130: api.Api.PostReplaceByClientOrderID:input_type -> api.PostOrderRequest
	35,  // 131: api.Api.PostReplaceOrder:input_type -> api.PostReplaceOrderRequest
	43,  // 132: api.Api.PostSettle:input_type -> api.PostSettleRequest
	73,  // 133: api.Api.PostTradeSwap:input_type -> api.TradeSwapRequest
	46,  // 134: api.Api.GetOrders:input_type -> api.GetOrdersRequest
	58,  // 135: api.Api.GetOpenOrders:input_type -> api.GetOpenOrdersRequest
	60,  // 136: api.Api.GetOrderByID:input_type -> api.GetOrderByIDRequest
	62,  // 137: api.Api.GetUnsettled:input_type -> api.GetUnsettledRequest
	74,  // 138: api.Api.PostRouteTradeSwap:input_type -> api.RouteTradeSwapRequest
	107, // 139: api.Api.PostPerpOrder:input_type -> api.PostPerpOrderRequest
	104, // 140: api.Api.GetCurrentPerpPositions:input_type -> api.GetCurrentPerpPositionsRequest
	19,  // 141: api.Api.GetOrderbooksStream:input_type -> api.GetOrderbooksRequest
	23,  // 142: api.Api.GetMarketDepthsStream:input_type -> api.GetMarketDepthsRequest
	12,  // 143: api.Api.GetTickersStream:input_type -> api.GetTickersRequest
	26,  // 144: api.Api.GetTradesStream:input_type -> api.GetTradesRequest
	49,  // 145: api.Api.GetOrderStatusStream:input_type -> api.GetOrderStatusStreamRequest
	80,  // 146: api.Api.GetRecentBlockHashStream:input_type -> api.GetRecentBlockHashRequest
	83,  // 147: api.Api.GetBlockStream:input_type -> api.GetBlockStreamRequest
	89,  // 148: api.Api.GetQuotesStream:input_type -> api.GetQuotesStreamRequest
	101, // 149: api.Api.GetPoolReservesStream:input_type -> api.GetPoolReservesStreamRequest
	102, // 150: api.Api.GetPricesStream:input_type -> api.GetPricesStreamRequest
	92,  // 151: api.Api.GetSwapsStream:input_type -> api.GetSwapsStreamRequest
	97,  // 152: api.Api.GetPrice:output_type -> api.GetPriceResponse
	10,  // 153: api.Api.GetMarkets:output_type -> api.GetMarketsResponse
	86,  // 154: api.Api.GetPools:output_type -> api.GetPoolsResponse
	13,  // 155: api.Api.GetTickers:output_type -> api.GetTickersResponse
	16,  // 156: api.Api.GetKline:output_type -> api.GetKlineResponse
	20,  // 157: api.Api.GetOrderbook:output_type -> api.GetOrderbookResponse
	24,  // 158: api.Api.GetMarketDepth:output_type -> api.GetMarketDepthResponse
	27,  // 159: api.Api.GetTrades:output_type -> api.GetTradesResponse
	71,  // 160: api.Api.GetQuotes:output_type -> api.GetQuotesResponse
	30,  // 161: api.Api.GetServerTime:output_type -> api.GetServerTimeResponse
	81,  // 162: api.Api.GetRecentBlockHash:output_type -> api.GetRecentBlockHashResponse
	32,  // 163: api.Api.GetAccountBalance:output_type -> api.GetAccountBalanceResponse
	36,  // 164: api.Api.PostOrder:output_type -> api.PostOrderResponse
	55,  // 165: api.Api.PostSubmit:output_type -> api.PostSubmitResponse
	57,  // 166: api.Api.PostSubmitBatch:output_type -> api.PostSubmitBatchResponse
	39,  // 167: api.Api.PostCancelOrder:output_type -> api.PostCancelOrderResponse
	39,  // 168: api.Api.PostCancelByClientOrderID:output_type -> api.PostCancelOrderResponse
	42,  // 169: api.Api.PostCancelAll:output_type -> api.PostCancelAllResponse
	36,  // 170: api.Api.PostReplaceByClientOrderID:output_type -> api.PostOrderResponse
	36,  // 171: api.Api.PostReplaceOrder:output_type -> api.PostOrderResponse
	44,  // 172: api.Api.PostSettle:output_type -> api.PostSettleResponse
	76,  // 173: api.Api.PostTradeSwap:output_type -> api.TradeSwapResponse
	47,  // 174: api.Api.GetOrders:output_type -> api.GetOrdersResponse
	59,  // 175: api.Api.GetOpenOrders:output_type -> api.GetOpenOrdersResponse
	61,  // 176: api.Api.GetOrderByID:output_type -> api.GetOrderByIDResponse
	65,  // 177: api.Api.GetUnsettled:output_type -> api.GetUnsettledResponse
	76,  // 178: api.Api.PostRouteTradeSwap:output_type -> api.TradeSwapResponse
	108, // 179: api.Api.PostPerpOrder:output_type -> api.PostPerpOrderResponse
	106, // 180: api.Api.GetCurrentPerpPositions:output_type -> api.GetCurrentPerpPositionsResponse
	66,  // 181: api.Api.GetOrderbooksStream:output_type -> api.GetOrderbooksStreamResponse
	67,  // 182: api.Api.GetMarketDepthsStream:output_type -> api.GetMarketDepthsStreamResponse
	68,  // 183: api.Api.GetTickersStream:output_type -> api.GetTickersStreamResponse
	69,  // 184: api.Api.GetTradesStream:output_type -> api.GetTradesStreamResponse
	50,  // 185: api.Api.GetOrderStatusStream:output_type -> api.GetOrderStatusStreamResponse
	81,  // 186: api.Api.GetRecentBlockHashStream:output_type -> api.GetRecentBlockHashResponse
	84,  // 187: api.Api.GetBlockStream:output_type -> api.GetBlockStreamResponse
	90,  // 188: api.Api.GetQuotesStream:output_type -> api.GetQuotesStreamResponse
	99,  // 189: api.Api.GetPoolReservesStream:output_type -> api.GetPoolReservesStreamResponse
	103, // 190: api.Api.GetPricesStream:output_type -> api.GetPricesStreamResponse
	93,  // 191: api.Api.GetSwapsStream:output_type -> api.GetSwapsStreamResponse
