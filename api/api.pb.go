...
type GetZetaStreamRequest struct {
	...
	Instructions []*InstructionRequest `protobuf:"bytes,1,rep,name=instructions,proto3" json:"instructions,omitempty"`
}
...
func (x *GetZetaStreamRequest) GetInstructions() []*InstructionRequest {
	if x != nil {
		return x.Instructions
	}
	return nil
...
func (x *GetZetaStreamResponse) GetInstructions() []*Instruction {
	if x != nil {
		return x.Instructions
	}
	return nil
...
var file_api_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x70, 0x6f, 0x6f, 0x6c, 0x73, 0x22, 0x53, 0x0a,
	0x14, 0x47, 0x65, 0x74, 0x5a, 0x65, 0x74, 0x61, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x3b, 0x0a, 0x0c, 0x69, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x52, 0x0c, 0x69, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x22, 0xd1, 0x01, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x5a, 0x65, 0x74, 0x61, 0x53, 0x74,
	...
	0x73, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x12, 0x34, 0x0a, 0x0c, 0x69, 0x6e, 0x73, 0x74, 0x72, 0x75,
	...
	0x69, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x38, 0x0a, 0x09,
	0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75,
	0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x09, 0x74, 0x69, 0x6d,
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x5a, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x50, 0x72, 0x69,
	...
	0x32, 0x99, 0x66, 0x0a, 0x03, 0x41, 0x70, 0x69, 0x12, 0xcd, 0x01, 0x0a, 0x0c, 0x47, 0x65, 0x74,
...
var file_api_proto_goTypes = []interface{}{
	...
	(*GetZetaStreamResponse)(nil),               // 151: api.GetZetaStreamResponse
...
var file_api_proto_depIdxs = []int32{
	...
	180, // 142: api.GetQuotesStreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	...
	180, // 146: api.GetSwapsStreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	127, // 147: api.GetNewRaydiumPoolsResponse.pool:type_name -> api.ProjectPool
	180, // 148: api.GetNewRaydiumPoolsResponse.timestamp:type_name -> google.protobuf.Timestamp
	6,   // 149: api.GetSwapsStreamUpdate.project:type_name -> api.Project
	180, // 150: api.GetBundleResultResponse.timestamp:type_name -> google.protobuf.Timestamp
	...
	180, // 156: api.GetPoolReservesStreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	...
	119, // 159: api.GetZetaStreamRequest.instructions:type_name -> api.InstructionRequest
	118, // 160: api.GetZetaStreamResponse.instructions:type_name -> api.Instruction
	180, // 161: api.GetZetaStreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	6,   // 162: api.GetPricesStreamRequest.projects:type_name -> api.Project
	145, // 163: api.GetPricesStreamResponse.price:type_name -> api.TokenPrice
	180, // 164: api.GetPricesStreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	6,   // 165: api.GetPriorityFeeRequest.project:type_name -> api.Project
	6,   // 166: api.GetPriorityFeeResponse.project:type_name -> api.Project
	179, // 167: api.GetMarketsResponseV2.markets:type_name -> api.GetMarketsResponseV2.MarketsEntry
	161, // 168: api.GetTickersResponseV2.tickers:type_name -> api.TickerV2
	164, // 169: api.GetOrderbookResponseV2.bids:type_name -> api.OrderbookItemV2
	164, // 170: api.GetOrderbookResponseV2.asks:type_name -> api.OrderbookItemV2
	167, // 171: api.GetMarketDepthResponseV2.bids:type_name -> api.MarketDepthItemV2
	167, // 172: api.GetMarketDepthResponseV2.asks:type_name -> api.MarketDepthItemV2
	42,  // 173: api.PostCancelOrderResponseV2.transactions:type_name -> api.TransactionMessage
	176, // 174: api.GetOpenOrdersResponseV2.orders:type_name -> api.OrderV2
	180, // 175: api.OrderV2.createdAt:type_name -> google.protobuf.Timestamp
	9,   // 176: api.GetMarketsResponse.MarketsEntry.value:type_name -> api.Market
	82,  // 177: api.PostJupiterSwapInstructionsResponse.AddressLookupTableAddressesEntry.value:type_name -> api.PublicKeys
	158, // 178: api.GetMarketsResponseV2.MarketsEntry.value:type_name -> api.MarketV2
	114, // 179: api.Api.GetRateLimit:input_type -> api.GetRateLimitRequest
	116, // 180: api.Api.GetTransaction:input_type -> api.GetTransactionRequest
	53,  // 181: api.Api.PostSubmitV2:input_type -> api.PostSubmitRequest
	55,  // 182: api.Api.PostSubmitBatchV2:input_type -> api.PostSubmitBatchRequest
	110, // 183: api.Api.GetRaydiumPools:input_type -> api.GetRaydiumPoolsRequest
	112, // 184: api.Api.GetRaydiumPoolReserve:input_type -> api.GetRaydiumPoolReserveRequest
	74,  // 185: api.Api.GetRaydiumQuotes:input_type -> api.GetRaydiumQuotesRequest
	141, // 186: api.Api.GetRaydiumPrices:input_type -> api.GetRaydiumPricesRequest
	84,  // 187: api.Api.PostRaydiumSwap:input_type -> api.PostRaydiumSwapRequest
	90,  // 188: api.Api.PostRaydiumRouteSwap:input_type -> api.PostRaydiumRouteSwapRequest
	76,  // 189: api.Api.GetJupiterQuotes:input_type -> api.GetJupiterQuotesRequest
	142, // 190: api.Api.GetJupiterPrices:input_type -> api.GetJupiterPricesRequest
	80,  // 191: api.Api.PostJupiterSwap:input_type -> api.PostJupiterSwapRequest
	81,  // 192: api.Api.PostJupiterSwapInstructions:input_type -> api.PostJupiterSwapInstructionsRequest
	92,  // 193: api.Api.PostJupiterRouteSwap:input_type -> api.PostJupiterRouteSwapRequest
	156, // 194: api.Api.GetMarketsV2:input_type -> api.GetMarketsRequestV2
	159, // 195: api.Api.GetTickersV2:input_type -> api.GetTickersRequestV2
	162, // 196: api.Api.GetOrderbookV2:input_type -> api.GetOrderbookRequestV2
	165, // 197: api.Api.GetMarketDepthV2:input_type -> api.GetMarketDepthRequestV2
	168, // 198: api.Api.PostOrderV2:input_type -> api.PostOrderRequestV2
	170, // 199: api.Api.PostCancelOrderV2:input_type -> api.PostCancelOrderRequestV2
	169, // 200: api.Api.PostReplaceOrderV2:input_type -> api.PostReplaceOrderRequestV2
	172, // 201: api.Api.PostSettleV2:input_type -> api.PostSettleRequestV2
	173, // 202: api.Api.GetOpenOrdersV2:input_type -> api.GetOpenOrdersRequestV2
	174, // 203: api.Api.GetUnsettledV2:input_type -> api.GetUnsettledRequestV2
	139, // 204: api.Api.GetPrice:input_type -> api.GetPriceRequest
	7,   // 205: api.Api.GetMarkets:input_type -> api.GetMarketsRequest
	108, // 206: api.Api.GetPools:input_type -> api.GetPoolsRequest
	10,  // 207: api.Api.GetTickers:input_type -> api.GetTickersRequest
	13,  // 208: api.Api.GetKline:input_type -> api.GetKlineRequest
	16,  // 209: api.Api.GetOrderbook:input_type -> api.GetOrderbookRequest
	20,  // 210: api.Api.GetMarketDepth:input_type -> api.GetMarketDepthRequest
	24,  // 211: api.Api.GetTrades:input_type -> api.GetTradesRequest
	72,  // 212: api.Api.GetQuotes:input_type -> api.GetQuotesRequest
	27,  // 213: api.Api.GetServerTime:input_type -> api.GetServerTimeRequest
	103, // 214: api.Api.GetRecentBlockHash:input_type -> api.GetRecentBlockHashRequest
	154, // 215: api.Api.GetPriorityFee:input_type -> api.GetPriorityFeeRequest
	...
	154, // 241: api.Api.GetPriorityFeeStream:input_type -> api.GetPriorityFeeRequest
	...
	152, // 244: api.Api.GetPricesStream:input_type -> api.GetPricesStreamRequest
	...
	157, // 262: api.Api.GetMarketsV2:output_type -> api.GetMarketsResponseV2
	160, // 263: api.Api.GetTickersV2:output_type -> api.GetTickersResponseV2
	163, // 264: api.Api.GetOrderbookV2:output_type -> api.GetOrderbookResponseV2
	166, // 265: api.Api.GetMarketDepthV2:output_type -> api.GetMarketDepthResponseV2
	37,  // 266: api.Api.PostOrderV2:output_type -> api.PostOrderResponse
	171, // 267: api.Api.PostCancelOrderV2:output_type -> api.PostCancelOrderResponseV2
	...
	175, // 270: api.Api.GetOpenOrdersV2:output_type -> api.GetOpenOrdersResponseV2
	...
	155, // 283: api.Api.GetPriorityFee:output_type -> api.GetPriorityFeeResponse
	...
	155, // 309: api.Api.GetPriorityFeeStream:output_type -> api.GetPriorityFeeResponse
	129, // 310: api.Api.GetQuotesStream:output_type -> api.GetQuotesStreamResponse
	147, // 311: api.Api.GetPoolReservesStream:output_type -> api.GetPoolReservesStreamResponse
	153, // 312: api.Api.GetPricesStream:output_type -> api.GetPricesStreamResponse
	134, // 313: api.Api.GetNewRaydiumPoolsStream:output_type -> api.GetNewRaydiumPoolsResponse
	132, // 314: api.Api.GetSwapsStream:output_type -> api.GetSwapsStreamResponse
	247, // [247:315] is the sub-list for method output_type
	179, // [179:247] is the sub-list for method input_type
