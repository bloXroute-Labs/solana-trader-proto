...
var file_api_proto_rawDesc = []byte{
	...
	0x50, 0x72, 0x69, 0x63, 0x65, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0xc1, 0x01, 0x0a,
	...
	0x75, 0x6e, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x2a, 0x2d, 0x0a, 0x0c, 0x4d, 0x61,
	...
	0x46, 0x54, 0x10, 0x06, 0x32, 0xdd, 0x38, 0x0a, 0x03, 0x41, 0x70, 0x69, 0x12, 0xaa, 0x01, 0x0a,
	...
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x60, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x64,
...
var file_api_proto_goTypes = []interface{}{
	...
	(*GetPerpPositionsRequest)(nil),          // 102: api.GetPerpPositionsRequest
	(*GetPerpPositionsResponse)(nil),         // 103: api.GetPerpPositionsResponse
	(*PostClosePerpPositionsRequest)(nil),    // 104: api.PostClosePerpPositionsRequest
	(*PostClosePerpPositionsResponse)(nil),   // 105: api.PostClosePerpPositionsResponse
	(*PerpPosition)(nil),                     // 106: api.PerpPosition
	(*PostPerpOrderRequest)(nil),             // 107: api.PostPerpOrderRequest
	(*PostPerpOrderResponse)(nil),            // 108: api.PostPerpOrderResponse
	nil,                                      // 109: api.GetMarketsResponse.MarketsEntry
	(*timestamp.Timestamp)(nil),              // 110: google.protobuf.Timestamp
	(common.OrderType)(0),                    // 111: common.OrderType
	(*common.PriceImpactPercent)(nil),        // 112: common.PriceImpactPercent
	(*common.Fee)(nil),                       // 113: common.Fee
	(common.PerpContract)(0),                 // 114: common.PerpContract
	(common.PerpPositionSide)(0),             // 115: common.PerpPositionSide
	(common.PerpOrderType)(0),                // 116: common.PerpOrderType
}
var file_api_proto_depIdxs = []int32{
	109, // 0: api.GetMarketsResponse.markets:type_name -> api.GetMarketsResponse.MarketsEntry
	...
	110, // 6: api.GetKlineRequest.from:type_name -> google.protobuf.Timestamp
	110, // 7: api.GetKlineRequest.to:type_name -> google.protobuf.Timestamp
	110, // 8: api.GetKlineResponse.timestamp:type_name -> google.protobuf.Timestamp
	15,  // 9: api.GetKlineResponse.candles:type_name -> api.Candle
	110, // 10: api.Candle.startTime:type_name -> google.protobuf.Timestamp
	110, // 11: api.Candle.updateTime:type_name -> google.protobuf.Timestamp
	...
	111, // 25: api.PostOrderRequest.type:type_name -> common.OrderType
	6,   // 26: api.PostOrderRequest.project:type_name -> api.Project
	1,   // 27: api.PostReplaceOrderRequest.side:type_name -> api.Side
	111, // 28: api.PostReplaceOrderRequest.type:type_name -> common.OrderType
	...
	111, // 41: api.GetOrdersRequest.types:type_name -> common.OrderType
	110, // 42: api.GetOrdersRequest.from:type_name -> google.protobuf.Timestamp
	...
	111, // 47: api.Order.types:type_name -> common.OrderType
	110, // 48: api.Order.createdAt:type_name -> google.protobuf.Timestamp
	...
	112, // 80: api.TradeSwapResponse.priceImpact:type_name -> common.PriceImpactPercent
	113, // 81: api.TradeSwapResponse.fees:type_name -> common.Fee
	76,  // 82: api.QuoteRoute.steps:type_name -> api.QuoteStep
	77,  // 83: api.QuoteStep.project:type_name -> api.StepProject
	112, // 84: api.QuoteStep.priceImpactPercent:type_name -> common.PriceImpactPercent
	113, // 85: api.QuoteStep.fee:type_name -> common.Fee
	...
	6,   // 105: api.GetPerpPositionsRequest.project:type_name -> api.Project
	114, // 106: api.GetPerpPositionsRequest.contracts:type_name -> common.PerpContract
	106, // 107: api.GetPerpPositionsResponse.perpPositions:type_name -> api.PerpPosition
	6,   // 108: api.PostClosePerpPositionsRequest.project:type_name -> api.Project
	114, // 109: api.PostClosePerpPositionsRequest.contracts:type_name -> common.PerpContract
	114, // 110: api.PerpPosition.contract:type_name -> common.PerpContract
	115, // 111: api.PerpPosition.positionSide:type_name -> common.PerpPositionSide
	6,   // 112: api.PostPerpOrderRequest.project:type_name -> api.Project
	114, // 113: api.PostPerpOrderRequest.contract:type_name -> common.PerpContract
	115, // 114: api.PostPerpOrderRequest.positionSide:type_name -> common.PerpPositionSide
	116, // 115: api.PostPerpOrderRequest.type:type_name -> common.PerpOrderType
	9,   // 116: api.GetMarketsResponse.MarketsEntry.value:type_name -> api.Market
	94,  // 117: api.Api.GetPrice:input_type -> api.GetPriceRequest
	7,   // 118: api.Api.GetMarkets:input_type -> api.GetMarketsRequest
	83,  // 119: api.Api.GetPools:input_type -> api.GetPoolsRequest
	10,  // 120: api.Api.GetTickers:input_type -> api.GetTickersRequest
	13,  // 121: api.Api.GetKline:input_type -> api.GetKlineRequest
	16,  // 122: api.Api.GetOrderbook:input_type -> api.GetOrderbookRequest
	20,  // 123: api.Api.GetMarketDepth:input_type -> api.GetMarketDepthRequest
	24,  // 124: api.Api.GetTrades:input_type -> api.GetTradesRequest
	68,  // 125: api.Api.GetQuotes:input_type -> api.GetQuotesRequest
	27,  // 126: api.Api.GetServerTime:input_type -> api.GetServerTimeRequest
	78,  // 127: api.Api.GetRecentBlockHash:input_type -> api.GetRecentBlockHashRequest
	29,  // 128: api.Api.GetAccountBalance:input_type -> api.GetAccountBalanceRequest
	32,  // 129: api.Api.PostOrder:input_type -> api.PostOrderRequest
	50,  // 130: api.Api.PostSubmit:input_type -> api.PostSubmitRequest
	52,  // 131: api.Api.PostSubmitBatch:input_type -> api.PostSubmitBatchRequest
	35,  // 132: api.Api.PostCancelOrder:input_type -> api.PostCancelOrderRequest
	36,  // 133: api.Api.PostCancelByClientOrderID:input_type -> api.PostCancelByClientOrderIDRequest
	38,  // 134: api.Api.PostCancelAll:input_type -> api.PostCancelAllRequest
	32,  // 135: api.Api.PostReplaceByClientOrderID:input_type -> api.PostOrderRequest
	33,  // 136: api.Api.PostReplaceOrder:input_type -> api.PostReplaceOrderRequest
	41,  // 137: api.Api.PostSettle:input_type -> api.PostSettleRequest
	71,  // 138: api.Api.PostTradeSwap:input_type -> api.TradeSwapRequest
	44,  // 139: api.Api.GetOrders:input_type -> api.GetOrdersRequest
	56,  // 140: api.Api.GetOpenOrders:input_type -> api.GetOpenOrdersRequest
	58,  // 141: api.Api.GetOrderByID:input_type -> api.GetOrderByIDRequest
	60,  // 142: api.Api.GetUnsettled:input_type -> api.GetUnsettledRequest
	72,  // 143: api.Api.PostRouteTradeSwap:input_type -> api.RouteTradeSwapRequest
	107, // 144: api.Api.PostPerpOrder:input_type -> api.PostPerpOrderRequest
	102, // 145: api.Api.GetPerpPositions:input_type -> api.GetPerpPositionsRequest
	104, // 146: api.Api.PostClosePerpPositions:input_type -> api.PostClosePerpPositionsRequest
	17,  // 147: api.Api.GetOrderbooksStream:input_type -> api.GetOrderbooksRequest
	21,  // 148: api.Api.GetMarketDepthsStream:input_type -> api.GetMarketDepthsRequest
	10,  // 149: api.Api.GetTickersStream:input_type -> api.GetTickersRequest
	24,  // 150: api.Api.GetTradesStream:input_type -> api.GetTradesRequest
	47,  // 151: api.Api.GetOrderStatusStream:input_type -> api.GetOrderStatusStreamRequest
	78,  // 152: api.Api.GetRecentBlockHashStream:input_type -> api.GetRecentBlockHashRequest
	81,  // 153: api.Api.GetBlockStream:input_type -> api.GetBlockStreamRequest
	87,  // 154: api.Api.GetQuotesStream:input_type -> api.GetQuotesStreamRequest
	99,  // 155: api.Api.GetPoolReservesStream:input_type -> api.GetPoolReservesStreamRequest
	100, // 156: api.Api.GetPricesStream:input_type -> api.GetPricesStreamRequest
	90,  // 157: api.Api.GetSwapsStream:input_type -> api.GetSwapsStreamRequest
	95,  // 158: api.Api.GetPrice:output_type -> api.GetPriceResponse
	8,   // 159: api.Api.GetMarkets:output_type -> api.GetMarketsResponse
	84,  // 160: api.Api.GetPools:output_type -> api.GetPoolsResponse
	11,  // 161: api.Api.GetTickers:output_type -> api.GetTickersResponse
	14,  // 162: api.Api.GetKline:output_type -> api.GetKlineResponse
	18,  // 163: api.Api.GetOrderbook:output_type -> api.GetOrderbookResponse
	22,  // 164: api.Api.GetMarketDepth:output_type -> api.GetMarketDepthResponse
	25,  // 165: api.Api.GetTrades:output_type -> api.GetTradesResponse
	69,  // 166: api.Api.GetQuotes:output_type -> api.GetQuotesResponse
	28,  // 167: api.Api.GetServerTime:output_type -> api.GetServerTimeResponse
	79,  // 168: api.Api.GetRecentBlockHash:output_type -> api.GetRecentBlockHashResponse
	30,  // 169: api.Api.GetAccountBalance:output_type -> api.GetAccountBalanceResponse
	34,  // 170: api.Api.PostOrder:output_type -> api.PostOrderResponse
	53,  // 171: api.Api.PostSubmit:output_type -> api.PostSubmitResponse
	55,  // 172: api.Api.PostSubmitBatch:output_type -> api.PostSubmitBatchResponse
	37,  // 173: api.Api.PostCancelOrder:output_type -> api.PostCancelOrderResponse
	37,  // 174: api.Api.PostCancelByClientOrderID:output_type -> api.PostCancelOrderResponse
	40,  // 175: api.Api.PostCancelAll:output_type -> api.PostCancelAllResponse
	34,  // 176: api.Api.PostReplaceByClientOrderID:output_type -> api.PostOrderResponse
	34,  // 177: api.Api.PostReplaceOrder:output_type -> api.PostOrderResponse
	42,  // 178: api.Api.PostSettle:output_type -> api.PostSettleResponse
	74,  // 179: api.Api.PostTradeSwap:output_type -> api.TradeSwapResponse
	45,  // 180: api.Api.GetOrders:output_type -> api.GetOrdersResponse
	57,  // 181: api.Api.GetOpenOrders:output_type -> api.GetOpenOrdersResponse
	59,  // 182: api.Api.GetOrderByID:output_type -> api.GetOrderByIDResponse
	63,  // 183: api.Api.GetUnsettled:output_type -> api.GetUnsettledResponse
	74,  // 184: api.Api.PostRouteTradeSwap:output_type -> api.TradeSwapResponse
	108, // 185: api.Api.PostPerpOrder:output_type -> api.PostPerpOrderResponse
	103, // 186: api.Api.GetPerpPositions:output_type -> api.GetPerpPositionsResponse
	105, // 187: api.Api.PostClosePerpPositions:output_type -> api.PostClosePerpPositionsResponse
	64,  // 188: api.Api.GetOrderbooksStream:output_type -> api.GetOrderbooksStreamResponse
	65,  // 189: api.Api.GetMarketDepthsStream:output_type -> api.GetMarketDepthsStreamResponse
	66,  // 190: api.Api.GetTickersStream:output_type -> api.GetTickersStreamResponse
	67,  // 191: api.Api.GetTradesStream:output_type -> api.GetTradesStreamResponse
	48,  // 192: api.Api.GetOrderStatusStream:output_type -> api.GetOrderStatusStreamResponse
	79,  // 193: api.Api.GetRecentBlockHashStream:output_type -> api.GetRecentBlockHashResponse
	82,  // 194: api.Api.GetBlockStream:output_type -> api.GetBlockStreamResponse
	88,  // 195: api.Api.GetQuotesStream:output_type -> api.GetQuotesStreamResponse
	97,  // 196: api.Api.GetPoolReservesStream:output_type -> api.GetPoolReservesStreamResponse
	101, // 197: api.Api.GetPricesStream:output_type -> api.GetPricesStreamResponse
	91,  // 198: api.Api.GetSwapsStream:output_type -> api.GetSwapsStreamResponse
	158, // [158:199] is the sub-list for method output_type
	117, // [117:158] is the sub-list for method input_type
