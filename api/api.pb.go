...
var file_api_proto_rawDesc = []byte{
	...
	0x58, 0x0a, 0x03, 0x41, 0x70, 0x69, 0x12, 0xaa, 0x01, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x50, 0x72,
...
var file_api_proto_depIdxs = []int32{
	...
	136, // 240: api.Api.GetNewPerpOrdersStream:input_type -> api.GetNewPerpOrdersStreamRequest
	138, // 241: api.Api.GetPerpTradesStream:input_type -> api.GetPerpTradesStreamRequest
	98,  // 242: api.Api.GetPrice:output_type -> api.GetPriceResponse
	8,   // 243: api.Api.GetMarkets:output_type -> api.GetMarketsResponse
	87,  // 244: api.Api.GetPools:output_type -> api.GetPoolsResponse
	11,  // 245: api.Api.GetTickers:output_type -> api.GetTickersResponse
	14,  // 246: api.Api.GetKline:output_type -> api.GetKlineResponse
	18,  // 247: api.Api.GetOrderbook:output_type -> api.GetOrderbookResponse
	22,  // 248: api.Api.GetMarketDepth:output_type -> api.GetMarketDepthResponse
	25,  // 249: api.Api.GetTrades:output_type -> api.GetTradesResponse
	72,  // 250: api.Api.GetQuotes:output_type -> api.GetQuotesResponse
	28,  // 251: api.Api.GetServerTime:output_type -> api.GetServerTimeResponse
	82,  // 252: api.Api.GetRecentBlockHash:output_type -> api.GetRecentBlockHashResponse
	30,  // 253: api.Api.GetAccountBalance:output_type -> api.GetAccountBalanceResponse
	33,  // 254: api.Api.GetTokenAccounts:output_type -> api.GetTokenAccountsResponse
	37,  // 255: api.Api.PostOrder:output_type -> api.PostOrderResponse
	56,  // 256: api.Api.PostSubmit:output_type -> api.PostSubmitResponse
	58,  // 257: api.Api.PostSubmitBatch:output_type -> api.PostSubmitBatchResponse
	40,  // 258: api.Api.PostCancelOrder:output_type -> api.PostCancelOrderResponse
	40,  // 259: api.Api.PostCancelByClientOrderID:output_type -> api.PostCancelOrderResponse
	43,  // 260: api.Api.PostCancelAll:output_type -> api.PostCancelAllResponse
	37,  // 261: api.Api.PostReplaceByClientOrderID:output_type -> api.PostOrderResponse
	37,  // 262: api.Api.PostReplaceOrder:output_type -> api.PostOrderResponse
	45,  // 263: api.Api.PostSettle:output_type -> api.PostSettleResponse
	77,  // 264: api.Api.PostTradeSwap:output_type -> api.TradeSwapResponse
	48,  // 265: api.Api.GetOrders:output_type -> api.GetOrdersResponse
	60,  // 266: api.Api.GetOpenOrders:output_type -> api.GetOpenOrdersResponse
	62,  // 267: api.Api.GetOrderByID:output_type -> api.GetOrderByIDResponse
	66,  // 268: api.Api.GetUnsettled:output_type -> api.GetUnsettledResponse
	77,  // 269: api.Api.PostRouteTradeSwap:output_type -> api.TradeSwapResponse
	135, // 270: api.Api.PostPerpOrder:output_type -> api.PostPerpOrderResponse
	130, // 271: api.Api.GetPerpPositions:output_type -> api.GetPerpPositionsResponse
	127, // 272: api.Api.GetOpenPerpOrders:output_type -> api.GetOpenPerpOrdersResponse
	121, // 273: api.Api.PostCancelPerpOrders:output_type -> api.PostCancelPerpOrdersResponse
	123, // 274: api.Api.PostCancelPerpOrder:output_type -> api.PostCancelPerpOrderResponse
	132, // 275: api.Api.PostClosePerpPositions:output_type -> api.PostClosePerpPositionsResponse
	107, // 276: api.Api.GetPerpOrderbook:output_type -> api.GetPerpOrderbookResponse
	107, // 277: api.Api.GetDriftSpotOrderbook:output_type -> api.GetPerpOrderbookResponse
	119, // 278: api.Api.PostCreateUser:output_type -> api.PostCreateUserResponse
	116, // 279: api.Api.GetUser:output_type -> api.GetUserResponse
	125, // 280: api.Api.PostManageCollateral:output_type -> api.PostManageCollateralResponse
	142, // 281: api.Api.PostSettlePNL:output_type -> api.PostSettlePNLResponse
	147, // 282: api.Api.PostSettlePNLs:output_type -> api.PostSettlePNLsResponse
	145, // 283: api.Api.GetAssets:output_type -> api.GetAssetsResponse
	152, // 284: api.Api.GetPerpContracts:output_type -> api.GetPerpContractsResponse
	149, // 285: api.Api.PostLiquidatePerp:output_type -> api.PostLiquidatePerpResponse
	154, // 286: api.Api.GetOpenPerpOrder:output_type -> api.GetOpenPerpOrderResponse
	67,  // 287: api.Api.GetOrderbooksStream:output_type -> api.GetOrderbooksStreamResponse
	68,  // 288: api.Api.GetMarketDepthsStream:output_type -> api.GetMarketDepthsStreamResponse
	69,  // 289: api.Api.GetTickersStream:output_type -> api.GetTickersStreamResponse
	70,  // 290: api.Api.GetTradesStream:output_type -> api.GetTradesStreamResponse
	51,  // 291: api.Api.GetOrderStatusStream:output_type -> api.GetOrderStatusStreamResponse
	82,  // 292: api.Api.GetRecentBlockHashStream:output_type -> api.GetRecentBlockHashResponse
	85,  // 293: api.Api.GetBlockStream:output_type -> api.GetBlockStreamResponse
	91,  // 294: api.Api.GetQuotesStream:output_type -> api.GetQuotesStreamResponse
	100, // 295: api.Api.GetPoolReservesStream:output_type -> api.GetPoolReservesStreamResponse
	104, // 296: api.Api.GetPricesStream:output_type -> api.GetPricesStreamResponse
	94,  // 297: api.Api.GetSwapsStream:output_type -> api.GetSwapsStreamResponse
	109, // 298: api.Api.GetPerpOrderbooksStream:output_type -> api.GetPerpOrderbooksStreamResponse
	137, // 299: api.Api.GetNewPerpOrdersStream:output_type -> api.GetNewPerpOrdersStreamResponse
	139, // 300: api.Api.GetPerpTradesStream:output_type -> api.GetPerpTradesStreamResponse
