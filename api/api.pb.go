...
type GetZetaStreamResponse struct {
	...
	MetaData  *TransactionMeta `protobuf:"bytes,4,opt,name=metaData,proto3" json:"metaData,omitempty"`
}
...
func (x *GetZetaStreamResponse) GetMetaData() *TransactionMeta {
	if x != nil {
		return x.MetaData
	}
	return nil
...
var file_api_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x22, 0x93, 0x01, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x5a, 0x65,
	...
	0x28, 0x09, 0x52, 0x06, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x12, 0x30, 0x0a, 0x08, 0x6d, 0x65,
	0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x65,
	0x74, 0x61, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x22, 0x5a, 0x0a, 0x16,
	...
	0x65, 0x72, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2a, 0x2d, 0x0a, 0x0c, 0x4d, 0x61, 0x72,
	...
	0x42, 0x4f, 0x4f, 0x4b, 0x10, 0x05, 0x32, 0xfb, 0x66, 0x0a, 0x03, 0x41, 0x70, 0x69, 0x12, 0xcd,
	...
	0x65, 0x6d, 0x30, 0x01, 0x12, 0x60, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x5a, 0x65, 0x74, 0x61, 0x54,
	0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d,
	0x12, 0x19, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x5a, 0x65, 0x74, 0x61, 0x53, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1a, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x47, 0x65, 0x74, 0x5a, 0x65, 0x74, 0x61, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52,
...
var file_api_proto_depIdxs = []int32{
	...
	122, // 159: api.GetZetaStreamResponse.metaData:type_name -> api.TransactionMeta
	...
	181, // 162: api.GetPricesStreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	...
	180, // 165: api.GetMarketsResponseV2.markets:type_name -> api.GetMarketsResponseV2.MarketsEntry
	162, // 166: api.GetTickersResponseV2.tickers:type_name -> api.TickerV2
	165, // 167: api.GetOrderbookResponseV2.bids:type_name -> api.OrderbookItemV2
	165, // 168: api.GetOrderbookResponseV2.asks:type_name -> api.OrderbookItemV2
	168, // 169: api.GetMarketDepthResponseV2.bids:type_name -> api.MarketDepthItemV2
	168, // 170: api.GetMarketDepthResponseV2.asks:type_name -> api.MarketDepthItemV2
	42,  // 171: api.PostCancelOrderResponseV2.transactions:type_name -> api.TransactionMessage
	177, // 172: api.GetOpenOrdersResponseV2.orders:type_name -> api.OrderV2
	181, // 173: api.OrderV2.createdAt:type_name -> google.protobuf.Timestamp
	...
	159, // 176: api.GetMarketsResponseV2.MarketsEntry.value:type_name -> api.MarketV2
	...
	141, // 184: api.Api.GetRaydiumPrices:input_type -> api.GetRaydiumPricesRequest
	...
	142, // 188: api.Api.GetJupiterPrices:input_type -> api.GetJupiterPricesRequest
	...
	157, // 192: api.Api.GetMarketsV2:input_type -> api.GetMarketsRequestV2
	160, // 193: api.Api.GetTickersV2:input_type -> api.GetTickersRequestV2
	163, // 194: api.Api.GetOrderbookV2:input_type -> api.GetOrderbookRequestV2
	166, // 195: api.Api.GetMarketDepthV2:input_type -> api.GetMarketDepthRequestV2
	169, // 196: api.Api.PostOrderV2:input_type -> api.PostOrderRequestV2
	171, // 197: api.Api.PostCancelOrderV2:input_type -> api.PostCancelOrderRequestV2
	170, // 198: api.Api.PostReplaceOrderV2:input_type -> api.PostReplaceOrderRequestV2
	173, // 199: api.Api.PostSettleV2:input_type -> api.PostSettleRequestV2
	174, // 200: api.Api.GetOpenOrdersV2:input_type -> api.GetOpenOrdersRequestV2
	175, // 201: api.Api.GetUnsettledV2:input_type -> api.GetUnsettledRequestV2
	139, // 202: api.Api.GetPrice:input_type -> api.GetPriceRequest
	...
	155, // 213: api.Api.GetPriorityFee:input_type -> api.GetPriorityFeeRequest
	...
	136, // 229: api.Api.GetBundleResultV2:input_type -> api.GetBundleResultRequest
	...
	150, // 239: api.Api.GetZetaTransactionStream:input_type -> api.GetZetaStreamRequest
	155, // 240: api.Api.GetPriorityFeeStream:input_type -> api.GetPriorityFeeRequest
	128, // 241: api.Api.GetQuotesStream:input_type -> api.GetQuotesStreamRequest
	149, // 242: api.Api.GetPoolReservesStream:input_type -> api.GetPoolReservesStreamRequest
	153, // 243: api.Api.GetPricesStream:input_type -> api.GetPricesStreamRequest
	133, // 244: api.Api.GetNewRaydiumPoolsStream:input_type -> api.GetNewRaydiumPoolsRequest
	131, // 245: api.Api.GetSwapsStream:input_type -> api.GetSwapsStreamRequest
	115, // 246: api.Api.GetRateLimit:output_type -> api.GetRateLimitResponse
	117, // 247: api.Api.GetTransaction:output_type -> api.GetTransactionResponse
	58,  // 248: api.Api.PostSubmitV2:output_type -> api.PostSubmitResponse
	57,  // 249: api.Api.PostSubmitBatchV2:output_type -> api.PostSubmitBatchResponse
	111, // 250: api.Api.GetRaydiumPools:output_type -> api.GetRaydiumPoolsResponse
	113, // 251: api.Api.GetRaydiumPoolReserve:output_type -> api.GetRaydiumPoolReserveResponse
	75,  // 252: api.Api.GetRaydiumQuotes:output_type -> api.GetRaydiumQuotesResponse
	143, // 253: api.Api.GetRaydiumPrices:output_type -> api.GetRaydiumPricesResponse
	85,  // 254: api.Api.PostRaydiumSwap:output_type -> api.PostRaydiumSwapResponse
	87,  // 255: api.Api.PostRaydiumRouteSwap:output_type -> api.PostRaydiumRouteSwapResponse
	77,  // 256: api.Api.GetJupiterQuotes:output_type -> api.GetJupiterQuotesResponse
	144, // 257: api.Api.GetJupiterPrices:output_type -> api.GetJupiterPricesResponse
	86,  // 258: api.Api.PostJupiterSwap:output_type -> api.PostJupiterSwapResponse
	83,  // 259: api.Api.PostJupiterSwapInstructions:output_type -> api.PostJupiterSwapInstructionsResponse
	88,  // 260: api.Api.PostJupiterRouteSwap:output_type -> api.PostJupiterRouteSwapResponse
	158, // 261: api.Api.GetMarketsV2:output_type -> api.GetMarketsResponseV2
	161, // 262: api.Api.GetTickersV2:output_type -> api.GetTickersResponseV2
	164, // 263: api.Api.GetOrderbookV2:output_type -> api.GetOrderbookResponseV2
	167, // 264: api.Api.GetMarketDepthV2:output_type -> api.GetMarketDepthResponseV2
	37,  // 265: api.Api.PostOrderV2:output_type -> api.PostOrderResponse
	172, // 266: api.Api.PostCancelOrderV2:output_type -> api.PostCancelOrderResponseV2
	37,  // 267: api.Api.PostReplaceOrderV2:output_type -> api.PostOrderResponse
	45,  // 268: api.Api.PostSettleV2:output_type -> api.PostSettleResponse
	176, // 269: api.Api.GetOpenOrdersV2:output_type -> api.GetOpenOrdersResponseV2
	66,  // 270: api.Api.GetUnsettledV2:output_type -> api.GetUnsettledResponse
	140, // 271: api.Api.GetPrice:output_type -> api.GetPriceResponse
	8,   // 272: api.Api.GetMarkets:output_type -> api.GetMarketsResponse
	109, // 273: api.Api.GetPools:output_type -> api.GetPoolsResponse
	11,  // 274: api.Api.GetTickers:output_type -> api.GetTickersResponse
	14,  // 275: api.Api.GetKline:output_type -> api.GetKlineResponse
	18,  // 276: api.Api.GetOrderbook:output_type -> api.GetOrderbookResponse
	22,  // 277: api.Api.GetMarketDepth:output_type -> api.GetMarketDepthResponse
	25,  // 278: api.Api.GetTrades:output_type -> api.GetTradesResponse
	73,  // 279: api.Api.GetQuotes:output_type -> api.GetQuotesResponse
	28,  // 280: api.Api.GetServerTime:output_type -> api.GetServerTimeResponse
	104, // 281: api.Api.GetRecentBlockHash:output_type -> api.GetRecentBlockHashResponse
	156, // 282: api.Api.GetPriorityFee:output_type -> api.GetPriorityFeeResponse
	30,  // 283: api.Api.GetAccountBalance:output_type -> api.GetAccountBalanceResponse
	33,  // 284: api.Api.GetTokenAccounts:output_type -> api.GetTokenAccountsResponse
	...
	137, // 298: api.Api.GetBundleResultV2:output_type -> api.GetBundleResultResponse
	...
	152, // 308: api.Api.GetZetaTransactionStream:output_type -> api.GetZetaStreamResponse
	156, // 309: api.Api.GetPriorityFeeStream:output_type -> api.GetPriorityFeeResponse
	...
	154, // 312: api.Api.GetPricesStream:output_type -> api.GetPricesStreamResponse
	...
	246, // [246:315] is the sub-list for method output_type
	177, // [177:246] is the sub-list for method input_type
