...
var file_api_proto_rawDesc = []byte{
	...
	0x10, 0x05, 0x32, 0x97, 0x32, 0x0a, 0x03, 0x41, 0x70, 0x69, 0x12, 0xaa, 0x01, 0x0a, 0x08, 0x47,
...
var file_api_proto_goTypes = []interface{}{
	...
	(*Block)(nil),                            // 79: api.Block
	(*GetBlockStreamRequest)(nil),            // 80: api.GetBlockStreamRequest
	(*GetBlockStreamResponse)(nil),           // 81: api.GetBlockStreamResponse
...
var file_api_proto_depIdxs = []int32{
	...
	102, // 38: api.GetOrdersRequest.from:type_name -> google.protobuf.Timestamp
	...
	102, // 44: api.Order.createdAt:type_name -> google.protobuf.Timestamp
	...
	79,  // 86: api.GetBlockStreamResponse.block:type_name -> api.Block
	7,   // 87: api.GetPoolsRequest.projects:type_name -> api.Project
	84,  // 88: api.GetPoolsResponse.projects:type_name -> api.ProjectPools
	7,   // 89: api.ProjectPools.project:type_name -> api.Project
	85,  // 90: api.ProjectPools.pools:type_name -> api.ProjectPool
	7,   // 91: api.GetQuotesStreamRequest.projects:type_name -> api.Project
	92,  // 92: api.GetQuotesStreamRequest.tokenPairs:type_name -> api.TokenPair
	88,  // 93: api.GetQuotesStreamResponse.quote:type_name -> api.GetQuotesStreamUpdate
	...
	91,  // 96: api.GetSwapsStreamResponse.swap:type_name -> api.GetSwapsStreamUpdate
	7,   // 97: api.GetSwapsStreamUpdate.project:type_name -> api.Project
	95,  // 98: api.GetPriceResponse.tokenPrices:type_name -> api.TokenPrice
	7,   // 99: api.TokenPrice.project:type_name -> api.Project
	97,  // 100: api.GetPoolReservesStreamResponse.reserves:type_name -> api.PoolReserves
	...
	95,  // 104: api.GetPricesStreamResponse.price:type_name -> api.TokenPrice
	10,  // 105: api.GetMarketsResponse.MarketsEntry.value:type_name -> api.Market
	93,  // 106: api.Api.GetPrice:input_type -> api.GetPriceRequest
	8,   // 107: api.Api.GetMarkets:input_type -> api.GetMarketsRequest
	82,  // 108: api.Api.GetPools:input_type -> api.GetPoolsRequest
	...
	21,  // 112: api.Api.GetTrades:input_type -> api.GetTradesRequest
	67,  // 113: api.Api.GetQuotes:input_type -> api.GetQuotesRequest
	24,  // 114: api.Api.GetServerTime:input_type -> api.GetServerTimeRequest
	77,  // 115: api.Api.GetRecentBlockHash:input_type -> api.GetRecentBlockHashRequest
	26,  // 116: api.Api.GetAccountBalance:input_type -> api.GetAccountBalanceRequest
	29,  // 117: api.Api.PostOrder:input_type -> api.PostOrderRequest
	47,  // 118: api.Api.PostSubmit:input_type -> api.PostSubmitRequest
	49,  // 119: api.Api.PostSubmitBatch:input_type -> api.PostSubmitBatchRequest
	32,  // 120: api.Api.PostCancelOrder:input_type -> api.PostCancelOrderRequest
	33,  // 121: api.Api.PostCancelByClientOrderID:input_type -> api.PostCancelByClientOrderIDRequest
	35,  // 122: api.Api.PostCancelAll:input_type -> api.PostCancelAllRequest
	29,  // 123: api.Api.PostReplaceByClientOrderID:input_type -> api.PostOrderRequest
	30,  // 124: api.Api.PostReplaceOrder:input_type -> api.PostReplaceOrderRequest
	38,  // 125: api.Api.PostSettle:input_type -> api.PostSettleRequest
	70,  // 126: api.Api.PostTradeSwap:input_type -> api.TradeSwapRequest
	41,  // 127: api.Api.GetOrders:input_type -> api.GetOrdersRequest
	53,  // 128: api.Api.GetOpenOrders:input_type -> api.GetOpenOrdersRequest
	55,  // 129: api.Api.GetOrderByID:input_type -> api.GetOrderByIDRequest
	57,  // 130: api.Api.GetUnsettled:input_type -> api.GetUnsettledRequest
	71,  // 131: api.Api.PostRouteTradeSwap:input_type -> api.RouteTradeSwapRequest
	18,  // 132: api.Api.GetOrderbooksStream:input_type -> api.GetOrderbooksRequest
	11,  // 133: api.Api.GetTickersStream:input_type -> api.GetTickersRequest
	8,   // 134: api.Api.GetMarketDepthStream:input_type -> api.GetMarketsRequest
	21,  // 135: api.Api.GetTradesStream:input_type -> api.GetTradesRequest
	44,  // 136: api.Api.GetOrderStatusStream:input_type -> api.GetOrderStatusStreamRequest
	77,  // 137: api.Api.GetRecentBlockHashStream:input_type -> api.GetRecentBlockHashRequest
	80,  // 138: api.Api.GetBlockStream:input_type -> api.GetBlockStreamRequest
	86,  // 139: api.Api.GetQuotesStream:input_type -> api.GetQuotesStreamRequest
	98,  // 140: api.Api.GetPoolReservesStream:input_type -> api.GetPoolReservesStreamRequest
	99,  // 141: api.Api.GetPricesStream:input_type -> api.GetPricesStreamRequest
	89,  // 142: api.Api.GetSwapsStream:input_type -> api.GetSwapsStreamRequest
	94,  // 143: api.Api.GetPrice:output_type -> api.GetPriceResponse
	9,   // 144: api.Api.GetMarkets:output_type -> api.GetMarketsResponse
	83,  // 145: api.Api.GetPools:output_type -> api.GetPoolsResponse
	12,  // 146: api.Api.GetTickers:output_type -> api.GetTickersResponse
	15,  // 147: api.Api.GetKline:output_type -> api.GetKlineResponse
	19,  // 148: api.Api.GetOrderbook:output_type -> api.GetOrderbookResponse
	22,  // 149: api.Api.GetTrades:output_type -> api.GetTradesResponse
	68,  // 150: api.Api.GetQuotes:output_type -> api.GetQuotesResponse
	25,  // 151: api.Api.GetServerTime:output_type -> api.GetServerTimeResponse
	78,  // 152: api.Api.GetRecentBlockHash:output_type -> api.GetRecentBlockHashResponse
	27,  // 153: api.Api.GetAccountBalance:output_type -> api.GetAccountBalanceResponse
	31,  // 154: api.Api.PostOrder:output_type -> api.PostOrderResponse
	50,  // 155: api.Api.PostSubmit:output_type -> api.PostSubmitResponse
	52,  // 156: api.Api.PostSubmitBatch:output_type -> api.PostSubmitBatchResponse
	34,  // 157: api.Api.PostCancelOrder:output_type -> api.PostCancelOrderResponse
	34,  // 158: api.Api.PostCancelByClientOrderID:output_type -> api.PostCancelOrderResponse
	37,  // 159: api.Api.PostCancelAll:output_type -> api.PostCancelAllResponse
	31,  // 160: api.Api.PostReplaceByClientOrderID:output_type -> api.PostOrderResponse
	31,  // 161: api.Api.PostReplaceOrder:output_type -> api.PostOrderResponse
	39,  // 162: api.Api.PostSettle:output_type -> api.PostSettleResponse
	73,  // 163: api.Api.PostTradeSwap:output_type -> api.TradeSwapResponse
	42,  // 164: api.Api.GetOrders:output_type -> api.GetOrdersResponse
	54,  // 165: api.Api.GetOpenOrders:output_type -> api.GetOpenOrdersResponse
	56,  // 166: api.Api.GetOrderByID:output_type -> api.GetOrderByIDResponse
	60,  // 167: api.Api.GetUnsettled:output_type -> api.GetUnsettledResponse
	73,  // 168: api.Api.PostRouteTradeSwap:output_type -> api.TradeSwapResponse
	61,  // 169: api.Api.GetOrderbooksStream:output_type -> api.GetOrderbooksStreamResponse
	62,  // 170: api.Api.GetTickersStream:output_type -> api.GetTickersStreamResponse
	64,  // 171: api.Api.GetMarketDepthStream:output_type -> api.GetMarketDepthStreamResponse
	66,  // 172: api.Api.GetTradesStream:output_type -> api.GetTradesStreamResponse
	45,  // 173: api.Api.GetOrderStatusStream:output_type -> api.GetOrderStatusStreamResponse
	78,  // 174: api.Api.GetRecentBlockHashStream:output_type -> api.GetRecentBlockHashResponse
	81,  // 175: api.Api.GetBlockStream:output_type -> api.GetBlockStreamResponse
	87,  // 176: api.Api.GetQuotesStream:output_type -> api.GetQuotesStreamResponse
	96,  // 177: api.Api.GetPoolReservesStream:output_type -> api.GetPoolReservesStreamResponse
	100, // 178: api.Api.GetPricesStream:output_type -> api.GetPricesStreamResponse
	90,  // 179: api.Api.GetSwapsStream:output_type -> api.GetSwapsStreamResponse
