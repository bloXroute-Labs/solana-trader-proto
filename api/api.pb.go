...
var file_api_proto_rawDesc = []byte{
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c,
	...
	0x45, 0x4e, 0x42, 0x4f, 0x4f, 0x4b, 0x10, 0x05, 0x32, 0x82, 0x5f, 0x0a, 0x03, 0x41, 0x70, 0x69,
	0x12, 0xd5, 0x01, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x52, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x8f, 0x01, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x1c, 0x12,
	0x1a, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x32, 0x2f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	...
	0x92, 0x41, 0x06, 0x0a, 0x04, 0x41, 0x4d, 0x4d, 0x73, 0x30, 0x01, 0x12, 0x6f, 0x0a, 0x16, 0x47,
	0x65, 0x74, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x53,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x22, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x42,
	...
	0x47, 0x65, 0x74, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73,
	0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x0a,
	0x92, 0x41, 0x07, 0x0a, 0x05, 0x54, 0x72, 0x61, 0x64, 0x65, 0x30, 0x01, 0x12, 0x56, 0x0a, 0x0e,
...
var file_api_proto_goTypes = []interface{}{
	...
	(*GetMarketsRequestV2)(nil),              // 143: api.GetMarketsRequestV2
	(*GetMarketsResponseV2)(nil),             // 144: api.GetMarketsResponseV2
	(*MarketV2)(nil),                         // 145: api.MarketV2
	(*GetTickersRequestV2)(nil),              // 146: api.GetTickersRequestV2
	(*GetTickersResponseV2)(nil),             // 147: api.GetTickersResponseV2
	(*TickerV2)(nil),                         // 148: api.TickerV2
	(*GetOrderbookRequestV2)(nil),            // 149: api.GetOrderbookRequestV2
	(*GetOrderbookResponseV2)(nil),           // 150: api.GetOrderbookResponseV2
	(*OrderbookItemV2)(nil),                  // 151: api.OrderbookItemV2
	(*GetMarketDepthRequestV2)(nil),          // 152: api.GetMarketDepthRequestV2
	(*GetMarketDepthResponseV2)(nil),         // 153: api.GetMarketDepthResponseV2
	(*MarketDepthItemV2)(nil),                // 154: api.MarketDepthItemV2
	(*PostOrderRequestV2)(nil),               // 155: api.PostOrderRequestV2
	(*PostReplaceOrderRequestV2)(nil),        // 156: api.PostReplaceOrderRequestV2
	(*PostCancelOrderRequestV2)(nil),         // 157: api.PostCancelOrderRequestV2
	(*PostCancelOrderResponseV2)(nil),        // 158: api.PostCancelOrderResponseV2
	(*PostSettleRequestV2)(nil),              // 159: api.PostSettleRequestV2
	(*GetOpenOrdersRequestV2)(nil),           // 160: api.GetOpenOrdersRequestV2
	(*GetUnsettledRequestV2)(nil),            // 161: api.GetUnsettledRequestV2
	(*GetOpenOrdersResponseV2)(nil),          // 162: api.GetOpenOrdersResponseV2
	(*OrderV2)(nil),                          // 163: api.OrderV2
	nil,                                      // 164: api.GetMarketsResponse.MarketsEntry
	nil,                                      // 165: api.GetMarketsResponseV2.MarketsEntry
	(*timestamp.Timestamp)(nil),              // 166: google.protobuf.Timestamp
	(common.OrderType)(0),                    // 167: common.OrderType
	(*common.PriceImpactPercentV2)(nil),      // 168: common.PriceImpactPercentV2
	(*common.Fee)(nil),                       // 169: common.Fee
	(*common.PriceImpactPercent)(nil),        // 170: common.PriceImpactPercent
}
var file_api_proto_depIdxs = []int32{
	164, // 0: api.GetMarketsResponse.markets:type_name -> api.GetMarketsResponse.MarketsEntry
	...
	166, // 6: api.GetKlineRequest.from:type_name -> google.protobuf.Timestamp
	166, // 7: api.GetKlineRequest.to:type_name -> google.protobuf.Timestamp
	166, // 8: api.GetKlineResponse.timestamp:type_name -> google.protobuf.Timestamp
	15,  // 9: api.GetKlineResponse.candles:type_name -> api.Candle
	166, // 10: api.Candle.startTime:type_name -> google.protobuf.Timestamp
	166, // 11: api.Candle.updateTime:type_name -> google.protobuf.Timestamp
	...
	167, // 26: api.PostOrderRequest.type:type_name -> common.OrderType
	6,   // 27: api.PostOrderRequest.project:type_name -> api.Project
	1,   // 28: api.PostReplaceOrderRequest.side:type_name -> api.Side
	167, // 29: api.PostReplaceOrderRequest.type:type_name -> common.OrderType
	...
	167, // 42: api.GetOrdersRequest.types:type_name -> common.OrderType
	166, // 43: api.GetOrdersRequest.from:type_name -> google.protobuf.Timestamp
	...
	167, // 48: api.Order.types:type_name -> common.OrderType
	166, // 49: api.Order.createdAt:type_name -> google.protobuf.Timestamp
	...
	166, // 52: api.GetOrderStatusStreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	...
	166, // 69: api.GetOrderbooksStreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	22,  // 70: api.GetMarketDepthsStreamResponse.Data:type_name -> api.GetMarketDepthResponse
	166, // 71: api.GetMarketDepthsStreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	11,  // 72: api.GetTickersStreamResponse.ticker:type_name -> api.GetTickersResponse
	166, // 73: api.GetTickersStreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	25,  // 74: api.GetTradesStreamResponse.trades:type_name -> api.GetTradesResponse
	166, // 75: api.GetTradesStreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	...
	168, // 84: api.PostRaydiumSwapResponse.priceImpact:type_name -> common.PriceImpactPercentV2
	169, // 85: api.PostRaydiumSwapResponse.fees:type_name -> common.Fee
	42,  // 86: api.PostJupiterSwapResponse.transactions:type_name -> api.TransactionMessage
	168, // 87: api.PostJupiterSwapResponse.priceImpact:type_name -> common.PriceImpactPercentV2
	169, // 88: api.PostJupiterSwapResponse.fees:type_name -> common.Fee
	...
	168, // 91: api.PostJupiterRouteSwapResponse.priceImpact:type_name -> common.PriceImpactPercentV2
	169, // 92: api.PostJupiterRouteSwapResponse.fees:type_name -> common.Fee
	...
	169, // 98: api.JupiterRouteStep.fee:type_name -> common.Fee
	98,  // 99: api.RouteStep.project:type_name -> api.StepProject
	169, // 100: api.RouteStep.fee:type_name -> common.Fee
	...
	170, // 103: api.TradeSwapResponse.priceImpact:type_name -> common.PriceImpactPercent
	169, // 104: api.TradeSwapResponse.fees:type_name -> common.Fee
	93,  // 105: api.QuoteRoute.steps:type_name -> api.QuoteStep
	98,  // 106: api.QuoteStep.project:type_name -> api.StepProject
	170, // 107: api.QuoteStep.priceImpactPercent:type_name -> common.PriceImpactPercent
	169, // 108: api.QuoteStep.fee:type_name -> common.Fee
	...
	168, // 111: api.JupiterQuoteStep.priceImpactPercent:type_name -> common.PriceImpactPercentV2
	169, // 112: api.JupiterQuoteStep.fee:type_name -> common.Fee
	97,  // 113: api.RaydiumQuoteRoute.steps:type_name -> api.RaydiumQuoteStep
	168, // 114: api.RaydiumQuoteStep.priceImpactPercent:type_name -> common.PriceImpactPercentV2
	169, // 115: api.RaydiumQuoteStep.fee:type_name -> common.Fee
	166, // 116: api.GetRecentBlockHashResponse.timestamp:type_name -> google.protobuf.Timestamp
	101, // 117: api.GetBlockStreamResponse.block:type_name -> api.Block
	166, // 118: api.GetBlockStreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	...
	166, // 133: api.GetQuotesStreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	...
	166, // 137: api.GetSwapsStreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	118, // 138: api.GetNewRaydiumPoolsResponse.pool:type_name -> api.ProjectPool
	166, // 139: api.GetNewRaydiumPoolsResponse.timestamp:type_name -> google.protobuf.Timestamp
	6,   // 140: api.GetSwapsStreamUpdate.project:type_name -> api.Project
	166, // 141: api.GetBundleResultsStreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	...
	166, // 147: api.GetPoolReservesStreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	...
	166, // 152: api.GetPricesStreamResponse.timestamp:type_name -> google.protobuf.Timestamp
	165, // 153: api.GetMarketsResponseV2.markets:type_name -> api.GetMarketsResponseV2.MarketsEntry
	148, // 154: api.GetTickersResponseV2.tickers:type_name -> api.TickerV2
	151, // 155: api.GetOrderbookResponseV2.bids:type_name -> api.OrderbookItemV2
	151, // 156: api.GetOrderbookResponseV2.asks:type_name -> api.OrderbookItemV2
	154, // 157: api.GetMarketDepthResponseV2.bids:type_name -> api.MarketDepthItemV2
	154, // 158: api.GetMarketDepthResponseV2.asks:type_name -> api.MarketDepthItemV2
	42,  // 159: api.PostCancelOrderResponseV2.transactions:type_name -> api.TransactionMessage
	163, // 160: api.GetOpenOrdersResponseV2.orders:type_name -> api.OrderV2
	166, // 161: api.OrderV2.createdAt:type_name -> google.protobuf.Timestamp
	9,   // 162: api.GetMarketsResponse.MarketsEntry.value:type_name -> api.Market
	145, // 163: api.GetMarketsResponseV2.MarketsEntry.value:type_name -> api.MarketV2
	...
	143, // 177: api.Api.GetMarketsV2:input_type -> api.GetMarketsRequestV2
	146, // 178: api.Api.GetTickersV2:input_type -> api.GetTickersRequestV2
	149, // 179: api.Api.GetOrderbookV2:input_type -> api.GetOrderbookRequestV2
	152, // 180: api.Api.GetMarketDepthV2:input_type -> api.GetMarketDepthRequestV2
	155, // 181: api.Api.PostOrderV2:input_type -> api.PostOrderRequestV2
	157, // 182: api.Api.PostCancelOrderV2:input_type -> api.PostCancelOrderRequestV2
	156, // 183: api.Api.PostReplaceOrderV2:input_type -> api.PostReplaceOrderRequestV2
	159, // 184: api.Api.PostSettleV2:input_type -> api.PostSettleRequestV2
	160, // 185: api.Api.GetOpenOrdersV2:input_type -> api.GetOpenOrdersRequestV2
	161, // 186: api.Api.GetUnsettledV2:input_type -> api.GetUnsettledRequestV2
	...
	78,  // 209: api.Api.PostTradeSwap:input_type -> api.TradeSwapRequest
	...
	85,  // 214: api.Api.PostRouteTradeSwap:input_type -> api.RouteTradeSwapRequest
	...
	50,  // 219: api.Api.GetOrderStatusStream:input_type -> api.GetOrderStatusStreamRequest
	99,  // 220: api.Api.GetRecentBlockHashStream:input_type -> api.GetRecentBlockHashRequest
	102, // 221: api.Api.GetBlockStream:input_type -> api.GetBlockStreamRequest
	119, // 222: api.Api.GetQuotesStream:input_type -> api.GetQuotesStreamRequest
	140, // 223: api.Api.GetPoolReservesStream:input_type -> api.GetPoolReservesStreamRequest
	141, // 224: api.Api.GetPricesStream:input_type -> api.GetPricesStreamRequest
	124, // 225: api.Api.GetNewRaydiumPoolsStream:input_type -> api.GetNewRaydiumPoolsRequest
	127, // 226: api.Api.GetBundleResultsStream:input_type -> api.GetBundleResultsStreamRequest
	122, // 227: api.Api.GetSwapsStream:input_type -> api.GetSwapsStreamRequest
	109, // 228: api.Api.GetRateLimit:output_type -> api.GetRateLimitResponse
	111, // 229: api.Api.GetTransaction:output_type -> api.GetTransactionResponse
	58,  // 230: api.Api.PostSubmitV2:output_type -> api.PostSubmitResponse
	57,  // 231: api.Api.PostSubmitBatchV2:output_type -> api.PostSubmitBatchResponse
	107, // 232: api.Api.GetRaydiumPools:output_type -> api.GetRaydiumPoolsResponse
	74,  // 233: api.Api.GetRaydiumQuotes:output_type -> api.GetRaydiumQuotesResponse
	134, // 234: api.Api.GetRaydiumPrices:output_type -> api.GetRaydiumPricesResponse
	81,  // 235: api.Api.PostRaydiumSwap:output_type -> api.PostRaydiumSwapResponse
	83,  // 236: api.Api.PostRaydiumRouteSwap:output_type -> api.PostRaydiumRouteSwapResponse
	76,  // 237: api.Api.GetJupiterQuotes:output_type -> api.GetJupiterQuotesResponse
	135, // 238: api.Api.GetJupiterPrices:output_type -> api.GetJupiterPricesResponse
	82,  // 239: api.Api.PostJupiterSwap:output_type -> api.PostJupiterSwapResponse
	84,  // 240: api.Api.PostJupiterRouteSwap:output_type -> api.PostJupiterRouteSwapResponse
	144, // 241: api.Api.GetMarketsV2:output_type -> api.GetMarketsResponseV2
	147, // 242: api.Api.GetTickersV2:output_type -> api.GetTickersResponseV2
	150, // 243: api.Api.GetOrderbookV2:output_type -> api.GetOrderbookResponseV2
	153, // 244: api.Api.GetMarketDepthV2:output_type -> api.GetMarketDepthResponseV2
	37,  // 245: api.Api.PostOrderV2:output_type -> api.PostOrderResponse
	158, // 246: api.Api.PostCancelOrderV2:output_type -> api.PostCancelOrderResponseV2
	37,  // 247: api.Api.PostReplaceOrderV2:output_type -> api.PostOrderResponse
	45,  // 248: api.Api.PostSettleV2:output_type -> api.PostSettleResponse
	162, // 249: api.Api.GetOpenOrdersV2:output_type -> api.GetOpenOrdersResponseV2
	66,  // 250: api.Api.GetUnsettledV2:output_type -> api.GetUnsettledResponse
	131, // 251: api.Api.GetPrice:output_type -> api.GetPriceResponse
	8,   // 252: api.Api.GetMarkets:output_type -> api.GetMarketsResponse
	105, // 253: api.Api.GetPools:output_type -> api.GetPoolsResponse
	11,  // 254: api.Api.GetTickers:output_type -> api.GetTickersResponse
	14,  // 255: api.Api.GetKline:output_type -> api.GetKlineResponse
	18,  // 256: api.Api.GetOrderbook:output_type -> api.GetOrderbookResponse
	22,  // 257: api.Api.GetMarketDepth:output_type -> api.GetMarketDepthResponse
	25,  // 258: api.Api.GetTrades:output_type -> api.GetTradesResponse
	72,  // 259: api.Api.GetQuotes:output_type -> api.GetQuotesResponse
	28,  // 260: api.Api.GetServerTime:output_type -> api.GetServerTimeResponse
	100, // 261: api.Api.GetRecentBlockHash:output_type -> api.GetRecentBlockHashResponse
	30,  // 262: api.Api.GetAccountBalance:output_type -> api.GetAccountBalanceResponse
	33,  // 263: api.Api.GetTokenAccounts:output_type -> api.GetTokenAccountsResponse
	37,  // 264: api.Api.PostOrder:output_type -> api.PostOrderResponse
	58,  // 265: api.Api.PostSubmit:output_type -> api.PostSubmitResponse
	57,  // 266: api.Api.PostSubmitBatch:output_type -> api.PostSubmitBatchResponse
	40,  // 267: api.Api.PostCancelOrder:output_type -> api.PostCancelOrderResponse
	40,  // 268: api.Api.PostCancelByClientOrderID:output_type -> api.PostCancelOrderResponse
	43,  // 269: api.Api.PostCancelAll:output_type -> api.PostCancelAllResponse
	37,  // 270: api.Api.PostReplaceByClientOrderID:output_type -> api.PostOrderResponse
	37,  // 271: api.Api.PostReplaceOrder:output_type -> api.PostOrderResponse
	45,  // 272: api.Api.PostSettle:output_type -> api.PostSettleResponse
	91,  // 273: api.Api.PostTradeSwap:output_type -> api.TradeSwapResponse
	48,  // 274: api.Api.GetOrders:output_type -> api.GetOrdersResponse
	60,  // 275: api.Api.GetOpenOrders:output_type -> api.GetOpenOrdersResponse
	62,  // 276: api.Api.GetOrderByID:output_type -> api.GetOrderByIDResponse
	66,  // 277: api.Api.GetUnsettled:output_type -> api.GetUnsettledResponse
	91,  // 278: api.Api.PostRouteTradeSwap:output_type -> api.TradeSwapResponse
	67,  // 279: api.Api.GetOrderbooksStream:output_type -> api.GetOrderbooksStreamResponse
	68,  // 280: api.Api.GetMarketDepthsStream:output_type -> api.GetMarketDepthsStreamResponse
	69,  // 281: api.Api.GetTickersStream:output_type -> api.GetTickersStreamResponse
	70,  // 282: api.Api.GetTradesStream:output_type -> api.GetTradesStreamResponse
	51,  // 283: api.Api.GetOrderStatusStream:output_type -> api.GetOrderStatusStreamResponse
	100, // 284: api.Api.GetRecentBlockHashStream:output_type -> api.GetRecentBlockHashResponse
	103, // 285: api.Api.GetBlockStream:output_type -> api.GetBlockStreamResponse
	120, // 286: api.Api.GetQuotesStream:output_type -> api.GetQuotesStreamResponse
	138, // 287: api.Api.GetPoolReservesStream:output_type -> api.GetPoolReservesStreamResponse
	142, // 288: api.Api.GetPricesStream:output_type -> api.GetPricesStreamResponse
	125, // 289: api.Api.GetNewRaydiumPoolsStream:output_type -> api.GetNewRaydiumPoolsResponse
	128, // 290: api.Api.GetBundleResultsStream:output_type -> api.GetBundleResultsStreamResponse
	123, // 291: api.Api.GetSwapsStream:output_type -> api.GetSwapsStreamResponse
