...
func request_Api_GetOrCreateUser_0(ctx context.Context, marshaler runtime.Marshaler, client ApiClient, req *http.Request, pathParams map[string]string) (Api_GetOrCreateUserClient, runtime.ServerMetadata, error) {
	...
	stream, err := client.GetOrCreateUser(ctx, &protoReq)
	if err != nil {
...
func RegisterApiHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ApiClient) error {
	...
	mux.Handle("POST", pattern_Api_GetOrCreateUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_Api_GetOrCreateUser_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	...
	forward_Api_GetOrCreateUser_0 = runtime.ForwardResponseStream
)
