...
var ffi_pb = require('./ffi_pb.js');
var common_pb = require('./common_pb.js');

function serialize_ffi_JupiterComputeRoutesRequest(arg) {
  if (!(arg instanceof ffi_pb.JupiterComputeRoutesRequest)) {
...
function deserialize_ffi_JupiterComputeRoutesRequest(buffer_arg) {
  return ffi_pb.JupiterComputeRoutesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_ffi_JupiterComputeRoutesResponse(arg) {
  if (!(arg instanceof ffi_pb.JupiterComputeRoutesResponse)) {
...
function deserialize_ffi_JupiterComputeRoutesResponse(buffer_arg) {
  return ffi_pb.JupiterComputeRoutesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_ffi_JupiterIsReadyRequest(arg) {
  if (!(arg instanceof ffi_pb.JupiterIsReadyRequest)) {
...
function deserialize_ffi_JupiterIsReadyRequest(buffer_arg) {
  return ffi_pb.JupiterIsReadyRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_ffi_JupiterIsReadyResponse(arg) {
  if (!(arg instanceof ffi_pb.JupiterIsReadyResponse)) {
...
function deserialize_ffi_JupiterIsReadyResponse(buffer_arg) {
  return ffi_pb.JupiterIsReadyResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_ffi_JupiterPairToAccountsRequest(arg) {
  if (!(arg instanceof ffi_pb.JupiterPairToAccountsRequest)) {
...
function deserialize_ffi_JupiterPairToAccountsRequest(buffer_arg) {
  return ffi_pb.JupiterPairToAccountsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_ffi_JupiterPairToAccountsResponse(arg) {
  if (!(arg instanceof ffi_pb.JupiterPairToAccountsResponse)) {
...
function deserialize_ffi_JupiterPairToAccountsResponse(buffer_arg) {
  return ffi_pb.JupiterPairToAccountsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_ffi_JupiterSwapTxRequest(arg) {
  if (!(arg instanceof ffi_pb.JupiterSwapTxRequest)) {
...
function deserialize_ffi_JupiterSwapTxRequest(buffer_arg) {
  return ffi_pb.JupiterSwapTxRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_ffi_JupiterSwapTxResponse(arg) {
  if (!(arg instanceof ffi_pb.JupiterSwapTxResponse)) {
...
function deserialize_ffi_JupiterSwapTxResponse(buffer_arg) {
  return ffi_pb.JupiterSwapTxResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_ffi_SolanaAccountsRequest(arg) {
  if (!(arg instanceof ffi_pb.SolanaAccountsRequest)) {
...
function deserialize_ffi_SolanaAccountsRequest(buffer_arg) {
  return ffi_pb.SolanaAccountsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_ffi_SolanaAccountsResponse(arg) {
  if (!(arg instanceof ffi_pb.SolanaAccountsResponse)) {
...
function deserialize_ffi_SolanaAccountsResponse(buffer_arg) {
  return ffi_pb.SolanaAccountsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
solanaAccountsStream: {
    ...
    requestStream: true,
    responseStream: true,
    requestType: ffi_pb.SolanaAccountsResponse,
    responseType: ffi_pb.SolanaAccountsRequest,
  ...
  jupiterIsReady: {
    ...
    requestType: ffi_pb.JupiterIsReadyRequest,
    responseType: ffi_pb.JupiterIsReadyResponse,
  ...
  jupiterPairToAccounts: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ffi_pb.JupiterPairToAccountsRequest,
    responseType: ffi_pb.JupiterPairToAccountsResponse,
  ...
  jupiterComputeRoutes: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ffi_pb.JupiterComputeRoutesRequest,
    responseType: ffi_pb.JupiterComputeRoutesResponse,
  ...
  jupiterSwapTx: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ffi_pb.JupiterSwapTxRequest,
    responseType: ffi_pb.JupiterSwapTxResponse,
