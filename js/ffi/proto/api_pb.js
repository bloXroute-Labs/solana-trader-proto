...
proto.api.GetOrCreateUserResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    useraccountaddress: jspb.Message.getFieldWithDefault(msg, 1, ""),
...
proto.api.GetOrCreateUserResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      var value = /** @type {string} */ (reader.readString());
      msg.setUseraccountaddress(value);
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
      msg.setTransaction(value);
...
proto.api.GetOrCreateUserResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUseraccountaddress();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
...
/**
 * optional string userAccountAddress = 1;
 * @return {string}
 */
proto.api.GetOrCreateUserResponse.prototype.getUseraccountaddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.api.GetOrCreateUserResponse.prototype.setUseraccountaddress = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
