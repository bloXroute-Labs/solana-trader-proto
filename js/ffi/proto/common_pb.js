...
goog.exportSymbol('proto.common.PriceImpactPercentV2', null, global);
/**
 ...
 * @constructor
 */
proto.common.PriceImpactPercentV2 = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.common.PriceImpactPercentV2, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.common.PriceImpactPercentV2.displayName = 'proto.common.PriceImpactPercentV2';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.common.PriceImpactPercentV2.prototype.toObject = function(opt_includeInstance) {
  return proto.common.PriceImpactPercentV2.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.common.PriceImpactPercentV2} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.common.PriceImpactPercentV2.toObject = function(includeInstance, msg) {
  var f, obj = {
    percent: jspb.Message.getFloatingPointFieldWithDefault(msg, 1, 0.0),
    infinity: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 */
proto.common.PriceImpactPercentV2.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.common.PriceImpactPercentV2;
  return proto.common.PriceImpactPercentV2.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.common.PriceImpactPercentV2} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.common.PriceImpactPercentV2}
 */
proto.common.PriceImpactPercentV2.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.common.PriceImpactPercentV2.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.common.PriceImpactPercentV2.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.common.PriceImpactPercentV2} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.common.PriceImpactPercentV2.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPercent();
  if (f !== 0.0) {
    writer.writeDouble(
 ...
 * @return {number}
 */
proto.common.PriceImpactPercentV2.prototype.getPercent = function() {
  return /** @type {number} */ (jspb.Message.getFloatingPointFieldWithDefault(this, 1, 0.0));
};
...
/**
 * @param {number} value
 * @return {!proto.common.PriceImpactPercentV2} returns this
 */
proto.common.PriceImpactPercentV2.prototype.setPercent = function(value) {
  return jspb.Message.setProto3FloatField(this, 1, value);
};


/**
 * optional string infinity = 2;
 * @return {string}
 */
proto.common.PriceImpactPercentV2.prototype.getInfinity = function() {
 ...
 * @return {!proto.common.PriceImpactPercentV2} returns this
 */
proto.common.PriceImpactPercentV2.prototype.setInfinity = function(value) {
